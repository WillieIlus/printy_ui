import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { B as prefixStorage, C as useStorage, D as useNitroOrigin, E as emojiCache, F as useOgImageRuntimeConfig, o as createError, G as fetchIsland, H as normaliseFontInput, I as theme, z as renderSSRHead, J as createHeadCore, K as withTrailingSlash, m as getQuery, L as handleCacheHeaders, M as setHeaders, O as setHeader, P as hash, Q as parseURL, R as setResponseHeader, S as proxyRequest, T as sendRedirect, U as resolveContext, V as H3Error } from './nitro.mjs';
