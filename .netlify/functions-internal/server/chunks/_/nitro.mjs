...
const _assets = {
  ["nuxt-og-image:fonts:Inter-normal-400.ttf.base64"]: {
    ...
    meta: {"type":"text/plain; charset=utf-8","etag":"\"652cc-qEeSD1DXCSV8gPP2rnBA6ePGdZ4\"","mtime":"2026-03-26T19:42:02.500Z"}
  },
  ["nuxt-og-image:fonts:Inter-normal-700.ttf.base64"]: {
    import: () => import('../raw/Inter-normal-700.ttf.mjs').then(r => r.default || r),
    meta: {"type":"text/plain; charset=utf-8","etag":"\"674f0-FZReUXHhPTnY0HmYVn2iPpKm9ds\"","mtime":"2026-03-26T19:42:02.501Z"}
  }
};
...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "bceae768-b798-46b8-a06c-1b5c9f6b2053",
  ...
  "public": {
    ...
    "mediaBase": "http://localhost:8000/media",
...
const _sYMNC55vP5czTcqfbFptenluQFmWLIkY7MCmpY7Ci8 = defineNitroPlugin(async (nitroApp) => {
...
const _gcORWcPvnNiuGidMJAraO8xHsGiwLfyOKBon7TUPYXE = defineNitroPlugin(async (nitroApp) => {
...
const _j4TRIzg3vNk3OZImSXAWJ_tQRxskyyrlFuVGOBSzE = defineNitroPlugin(async (nitro) => {
  return;
});

const script = "\"use strict\";(()=>{const t=window,e=document.documentElement,c=[\"dark\",\"light\"],n=getStorageValue(\"localStorage\",\"printy-color-mode\")||\"system\";let i=n===\"system\"?u():n;const r=e.getAttribute(\"data-color-mode-forced\");r&&(i=r),l(i),t[\"__NUXT_COLOR_MODE__\"]={preference:n,value:i,getColorScheme:u,addColorScheme:l,removeColorScheme:d};function l(o){const s=\"\"+o+\"\",a=\"\";e.classList?e.classList.add(s):e.className+=\" \"+s,a&&e.setAttribute(\"data-\"+a,o)}function d(o){const s=\"\"+o+\"\",a=\"\";e.classList?e.classList.remove(s):e.className=e.className.replace(new RegExp(s,\"g\"),\"\"),a&&e.removeAttribute(\"data-\"+a)}function f(o){return t.matchMedia(\"(prefers-color-scheme\"+o+\")\")}function u(){if(t.matchMedia&&f(\"\").media!==\"not all\"){for(const o of c)if(f(\":\"+o).matches)return o}return\"light\"}})();function getStorageValue(t,e){switch(t){case\"localStorage\":return window.localStorage.getItem(e);case\"sessionStorage\":return window.sessionStorage.getItem(e);case\"cookie\":return getCookie(e);default:return null}}function getCookie(t){const c=(\"; \"+window.document.cookie).split(\"; \"+t+\"=\");if(c.length===2)return c.pop()?.split(\";\").shift()}";

const _m5ar4cxDs0NmrCMmRNWzUcJEkceUEsE44cMOjpr1PPQ = (function(nitro) {
...
const plugins = [
  _sYMNC55vP5czTcqfbFptenluQFmWLIkY7MCmpY7Ci8,
_gcORWcPvnNiuGidMJAraO8xHsGiwLfyOKBon7TUPYXE,
_j4TRIzg3vNk3OZImSXAWJ_tQRxskyyrlFuVGOBSzE,
_m5ar4cxDs0NmrCMmRNWzUcJEkceUEsE44cMOjpr1PPQ
];
...
const appHead = {"link":[{"rel":"stylesheet","href":"https://fonts.googleapis.com/css2?family=Montserrat:wght@400;500;600;700;800;900&display=swap"},{"rel":"icon","type":"image/x-icon","href":"/printy-brand-assets-ready/favicons/favicon-light.ico"}],"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1, viewport-fit=cover"},{"name":"description","content":"Get instant printing quotes for business cards, flyers, posters, and more. Browse templates and request quotes from trusted print shops in Kenya."},{"property":"og:type","content":"website"},{"property":"og:site_name","content":"Printy"},{"property":"og:image","content":"https://printy.ke/og-default.png"},{"name":"twitter:card","content":"summary_large_image"},{"name":"twitter:site","content":"@printy_ke"}],"style":[],"script":[],"noscript":[],"title":"Printy - Instant Printing Quotes","htmlAttrs":{"lang":"en","class":"scroll-smooth"}};
...
const _41EVMw = defineCachedEventHandler(async (event) => {
...
const _f6HrjQ = eventHandler(async (e) => {
...
const _uGfgiN = defineEventHandler(async (e) => {
  const nitroApp = useNitroApp();
...
const _Qf3xeK = defineEventHandler(async (e) => {
...
const _XW7Gjj = defineEventHandler(async (e) => {
...
const _EPxD2y = defineEventHandler(sitemapXmlEventHandler);

const _dAbSGR = lazyEventHandler(() => {
...
const _lazy_X9YAIu = () => import('../routes/renderer.mjs');
const _lazy_pbvSsX = () => import('../routes/__og-image__/font/font.mjs');
const _lazy_DTpLXZ = () => import('../routes/__og-image__/image/image.mjs');
...
const handlers = [
  ...
  { route: '/api/_nuxt_icon/:collection', handler: _41EVMw, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _f6HrjQ, lazy: false, middleware: true, method: undefined },
  { route: '/robots.txt', handler: _uGfgiN, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _Qf3xeK, lazy: false, middleware: true, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _XW7Gjj, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _EPxD2y, lazy: false, middleware: false, method: undefined },
  { route: '/__og-image__/font/**', handler: _lazy_pbvSsX, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/image/**', handler: _lazy_DTpLXZ, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/static/**', handler: _lazy_DTpLXZ, lazy: true, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _dAbSGR, lazy: false, middleware: false, method: undefined },
