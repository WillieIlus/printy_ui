...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<aside${ssrRenderAttrs(mergeProps({ class: "rounded-3xl border border-[var(--p-border)] bg-[var(--p-surface)] shadow-sm" }, _attrs))}><div class="flex items-start justify-between gap-4 border-b border-[var(--p-border)] px-5 py-4"><div><p class="text-xs font-semibold uppercase tracking-[0.2em] text-[var(--p-text-muted)]">Editor</p><h2 class="mt-1 text-lg font-semibold text-[var(--p-text)]">${ssrInterpolate(__props.title)}</h2>`);
...
//# sourceMappingURL=AdminWorkspaceFormPanel-MfBDvykR.mjs.map
