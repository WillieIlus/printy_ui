...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "col-span-12 overflow-hidden rounded-[30px] border border-[var(--p-border)] bg-[var(--p-surface-raised)] p-6 shadow-sm backdrop-blur-xl sm:p-7" }, _attrs))}><div class="absolute"></div><div class="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between sm:gap-6"><div class="min-w-0 flex-1 space-y-1"><p class="text-[11px] font-semibold uppercase tracking-[0.28em] text-orange-600 dark:text-orange-300/90"> Printy Workspace </p><h1 class="text-3xl font-semibold text-[var(--p-text)] sm:text-4xl">${ssrInterpolate(__props.title)}</h1>`);
      if (__props.subtitle) {
        _push(`<p class="max-w-3xl text-sm leading-6 text-[var(--p-text-muted)]">${ssrInterpolate(__props.subtitle)}</p>`);
      } else {
        _push(`<!---->`);
      }
...
//# sourceMappingURL=DashboardPageHeader-5_E3NIzR.mjs.map
