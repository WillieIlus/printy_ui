...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "empty-state rounded-xl border border-[var(--p-border-dim)] bg-[var(--p-surface)] p-8 text-center" }, _attrs))}><div class="flex justify-center">`);
      ...
      if (__props.description) {
        _push(`<p class="mt-2 text-sm text-[var(--p-text-muted)]">${ssrInterpolate(__props.description)}</p>`);
      } else {
        _push(`<!---->`);
      }
...
//# sourceMappingURL=EmptyState-InVpxbUI.mjs.map
