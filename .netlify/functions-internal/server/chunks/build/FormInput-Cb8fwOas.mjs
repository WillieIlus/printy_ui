          ...
          if (_push2) {
            ...
            if (__props.icon) {
              ...
              _push2(ssrRenderComponent(_component_UIcon, {
                name: __props.icon,
                class: ["h-5 w-5 text-[var(--p-text-muted)] transition-colors", { "text-flamingo-500": errors.length }]
            ...
            _push2(`<input${ssrRenderAttrs(mergeProps(field, {
              ...
              autocomplete: computedAutocomplete.value,
              ...
              class: ["w-full rounded-xl border py-3 text-[0.95rem] leading-6 transition-all disabled:cursor-not-allowed disabled:opacity-50", [
                ...
                errors.length ? "border-red-500 bg-red-50/90 text-[var(--p-text)] placeholder-red-300 dark:bg-red-950/35 dark:placeholder-red-700 focus:border-red-600 focus:ring-2 focus:ring-red-500/25" : "border-[var(--p-border)] bg-[var(--p-surface)] text-[var(--p-text)] placeholder-[var(--p-text-muted)] hover:border-[var(--p-text-muted)] focus:border-flamingo-500 focus:ring-2 focus:ring-flamingo-500/20 disabled:bg-[var(--p-surface-sunken)]"
              ]],
              "aria-invalid": errors.length ? "true" : "false"
            }))}${_scopeId}>`);
            if (showPasswordToggle.value) {
              _push2(`<button type="button" aria-label="Toggle password visibility" class="absolute inset-y-0 right-0 flex items-center pr-3.5 text-[var(--p-text-muted)] transition-colors hover:text-[var(--p-text-dim)]"${_scopeId}>`);
              _push2(ssrRenderComponent(_component_UIcon, {
              ...
              createVNode("div", null, [
                ...
                createVNode("div", { class: "relative" }, [
                  ...
                  createVNode("input", mergeProps(field, {
                    ...
                    "aria-invalid": errors.length ? "true" : "false"
                  }), null, 16, ["id", "type", "autocomplete", "placeholder", "disabled", "aria-invalid"]),
...
//# sourceMappingURL=FormInput-Cb8fwOas.mjs.map
