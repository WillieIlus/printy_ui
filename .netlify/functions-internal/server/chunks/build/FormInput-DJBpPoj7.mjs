import { defineComponent, toRef, resolveDynamicComponent, h, computed, ref, reactive, toValue, unref, isRef, watch, provide, readonly, mergeProps, withCtx, createVNode, openBlock, createBlock, createTextVNode, toDisplayString, createCommentVNode, watchEffect, nextTick, shallowRef, getCurrentInstance, inject, useSSRContext } from 'vue';
...
const FieldContextKey = /* @__PURE__ */ Symbol("vee-validate-field-instance");
const IS_ABSENT = /* @__PURE__ */ Symbol("Default empty value");
        ...
        default: withCtx(({ field, errors }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (!__props.hideLabel) {
              _push2(`<label${ssrRenderAttr("for", __props.name)} class="mb-1.5 block text-sm font-medium text-[var(--p-text-dim)]"${_scopeId}>${ssrInterpolate(__props.label)} `);
              if (__props.required) {
            ...
            if (__props.icon) {
              _push2(`<div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3.5"${_scopeId}>`);
              _push2(ssrRenderComponent(_component_UIcon, {
                name: __props.icon,
                class: ["h-5 w-5 text-gray-400 transition-colors", { "text-flamingo-500": errors.length }]
            ...
            _push2(`<input${ssrRenderAttrs(mergeProps(field, {
              ...
              class: ["w-full rounded-xl border-2 py-3 text-sm transition-all disabled:cursor-not-allowed disabled:opacity-50", [
                __props.icon ? "pl-10" : "pl-4",
                showPasswordToggle.value ? "pr-12" : "pr-4",
                errors.length ? "border-red-500 bg-red-50 dark:bg-red-950/30 placeholder-red-300 dark:placeholder-red-800 focus:border-red-600 focus:ring-2 focus:ring-red-500/30" : "border-[var(--p-border)] bg-[var(--p-surface)] text-[var(--p-text)] placeholder-[var(--p-text-muted)] hover:border-[var(--p-text-muted)] focus:border-flamingo-500 focus:ring-2 focus:ring-flamingo-500/20 disabled:bg-[var(--p-surface-sunken)]"
              ]]
            }))}${_scopeId}>`);
            if (showPasswordToggle.value) {
              _push2(`<button type="button" aria-label="Toggle password visibility" class="absolute inset-y-0 right-0 flex items-center pr-3.5 text-gray-400 dark:text-gray-500 transition-colors hover:text-gray-600 dark:hover:text-gray-300"${_scopeId}>`);
              _push2(ssrRenderComponent(_component_UIcon, {
                name: passwordVisible.value ? "i-lucide-eye-off" : "i-lucide-eye",
                class: "h-5 w-5"
              }, null, _parent2, _scopeId));
              _push2(`</button>`);
            } else {
            ...
            return [
              createVNode("div", null, [
                ...
                createVNode("div", { class: "relative" }, [
                  ...
                  }), null, 16, ["id", "type", "placeholder", "disabled"]),
                  showPasswordToggle.value ? (openBlock(), createBlock("button", {
                    key: 1,
                    type: "button",
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/forms/FormInput.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const __nuxt_component_1 = Object.assign(_sfc_main, { __name: "FormsFormInput" });

export { Form as F, __nuxt_component_1 as _, Field as a, useField as b, useForm as u };
//# sourceMappingURL=FormInput-DJBpPoj7.mjs.map
