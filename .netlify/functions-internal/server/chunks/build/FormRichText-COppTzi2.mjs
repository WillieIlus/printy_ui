import { a as Field } from './FormInput-DJBpPoj7.mjs';
import { a as _sfc_main$f, l as _export_sfc, b as __nuxt_component_2$1 } from './server.mjs';
...
const __nuxt_component_1 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$1, [["__scopeId", "data-v-04953545"]]), { __name: "EditorRichTextEditor" });
      ...
      _push(ssrRenderComponent(_component_VeeField, mergeProps({
        ...
        default: withCtx(({ field, errors }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</label><div class="${ssrRenderClass([errors.length ? "border-red-500 bg-red-50 dark:bg-red-950/30 ring-2 ring-red-500/30" : "border-[var(--p-border)]", "rounded-xl border-2 transition-all"])}"${_scopeId}>`);
            ...
            return [
              createVNode("div", null, [
                ...
                createVNode("div", {
                  class: ["rounded-xl border-2 transition-all", errors.length ? "border-red-500 bg-red-50 dark:bg-red-950/30 ring-2 ring-red-500/30" : "border-[var(--p-border)]"]
                }, [
...
//# sourceMappingURL=FormRichText-COppTzi2.mjs.map
