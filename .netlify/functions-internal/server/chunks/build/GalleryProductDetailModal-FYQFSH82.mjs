...
import { a1 as defu } from '../_/nitro.mjs';
...
import { i as useAppConfig, y as usePortal, t as tv, b as _sfc_main$9, K as __nuxt_component_5, a as _sfc_main$f } from './server.mjs';
import { _ as _sfc_main$3 } from './Badge-Dn_IFHF_.mjs';
import { u as useProductPriceDisplay } from './ProductTweakModal-EHKZZOYs.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderTeleport(_push, (_push2) => {
        if (__props.modelValue) {
          _push2(`<div class="fixed inset-0 z-50 flex items-center justify-center p-4" role="dialog" aria-modal="true"><div class="absolute inset-0 bg-black/50 backdrop-blur-sm"></div><div class="modal-panel relative z-[100010] max-h-[90vh] w-full max-w-lg overflow-y-auto rounded-lg border border-[var(--p-border)] bg-[var(--p-surface-raised)] shadow-lg"><div class="p-5 sm:p-6"><div class="flex items-start justify-between gap-4 mb-4"><div class="min-w-0"><h2 class="text-lg font-semibold text-[var(--p-text)]">${ssrInterpolate(__props.product?.name)}</h2>`);
          ...
          if (__props.productImageUrl) {
            _push2(`<div class="mb-4 aspect-[4/3] overflow-hidden rounded-lg bg-[var(--p-surface-sunken)]">`);
...
//# sourceMappingURL=GalleryProductDetailModal-FYQFSH82.mjs.map
