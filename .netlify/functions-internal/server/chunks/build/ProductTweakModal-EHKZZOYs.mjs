import { f as formatCurrency, c as formatCurrencyRange } from './formatters-FW8HHCjc.mjs';
...
import { defineComponent, useModel, computed, watch, mergeProps, unref, withCtx, createVNode, mergeModels, useSSRContext } from 'vue';
import { ssrRenderComponent } from 'vue/server-renderer';
import { useI18n } from 'vue-i18n';
import { d as useAuthStore, e as useToast, g as useAnalyticsTracking } from './server.mjs';
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_QuotesQuoteConfigModal, mergeProps({
        open: isOpen.value,
        eyebrow: unref(t)("shop.quoteConfiguration"),
        title: unref(t)("shop.configureProduct", { name: __props.product.name }),
        description: unref(t)("shop.productTweakDescription"),
        size: "lg",
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(__nuxt_component_1, null, {
              flat: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_QuotesPublicCalculator, {
                    title: unref(t)("shop.tweakProduct", { name: __props.product.name }),
                    description: unref(t)("shop.tweakFlowDescription"),
                    eyebrow: unref(t)("shop.tweakFlow"),
                    mode: unref(mode),
                  ...
                  return [
                    createVNode(_component_QuotesPublicCalculator, {
                      ...
                      "fixed-shop-name": __props.shopName,
                      onSubmit
                    }, null, 8, ["title", "description", "eyebrow", "mode", "product", "fixed-shop-slug", "fixed-shop-name"])
                  ];
                }
              }),
              booklet: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(__nuxt_component_3, {
                    title: unref(t)("shop.bookletRequestForProduct", { name: __props.product.name }),
                    description: unref(t)("shop.bookletFlowDescription"),
                    eyebrow: unref(t)("shop.bookletFlow"),
                    "fixed-shop-slug": __props.shopSlug,
                    "fixed-shop-name": __props.shopName
                  }, null, _parent3, _scopeId2));
                } else {
              ...
              large_format: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(__nuxt_component_4, {
                    title: unref(t)("shop.largeFormatRequestForProduct", { name: __props.product.name }),
                    description: unref(t)("shop.largeFormatFlowDescription"),
                    eyebrow: unref(t)("shop.largeFormatFlow"),
                    "fixed-shop-slug": __props.shopSlug,
                    "fixed-shop-name": __props.shopName
                  }, null, _parent3, _scopeId2));
                } else {
...
//# sourceMappingURL=ProductTweakModal-EHKZZOYs.mjs.map
