  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({
        class: ["overflow-hidden rounded-xl border border-[var(--p-border)] bg-[var(--p-surface-raised)] shadow-sm backdrop-blur-xl", colSpanClass.value]
      }, _attrs))}>`);
...
//# sourceMappingURL=SectionCard-BarCx775.mjs.map
