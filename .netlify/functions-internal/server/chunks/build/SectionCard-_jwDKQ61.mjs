  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({
        class: ["overflow-hidden rounded-lg border border-[var(--p-border)] bg-[var(--p-surface-raised)] shadow-md backdrop-blur-xl", colSpanClass.value]
      }, _attrs))}>`);
      if (__props.title || _ctx.$slots["card-header"]) {
        _push(`<div class="border-b border-[var(--p-border-dim)] px-5 py-3.5">`);
        ssrRenderSlot(_ctx.$slots, "card-header", {}, () => {
          _push(`<h3 class="text-sm font-semibold tracking-[0.01em] text-[var(--p-text-dim)]">${ssrInterpolate(__props.title)}</h3>`);
        }, _push, _parent);
        _push(`</div>`);
      } else {
        _push(`<!---->`);
...
//# sourceMappingURL=SectionCard-_jwDKQ61.mjs.map
