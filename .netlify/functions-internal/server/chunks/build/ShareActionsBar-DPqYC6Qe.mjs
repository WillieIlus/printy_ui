import { e as useToast, d as _sfc_main$9, a as _sfc_main$f } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    async function copySummary() {
      copying.value = true;
      try {
        await (void 0).clipboard.writeText(props.summaryText);
        showCopiedState();
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.summaryText) {
        ...
        _push(ssrRenderComponent(_component_UButton, {
          ...
          size: "sm",
          color: "neutral",
          loading: unref(copying),
          onClick: copySummary
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(_component_UIcon, {
                name: unref(copied) ? "i-lucide-check" : "i-lucide-copy",
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(_component_UIcon, {
                ...
                class: ["w-4 h-4 mr-1.5", { "animate-spin": unref(openingWhatsApp) }]
              }, null, _parent2, _scopeId));
...
const __nuxt_component_7 = Object.assign(_sfc_main, { __name: "ShareActionsBar" });

export { __nuxt_component_7 as _ };
//# sourceMappingURL=ShareActionsBar-DPqYC6Qe.mjs.map
