...
import { defineComponent, computed, ref, watch, mergeProps, unref, withCtx, createVNode, toDisplayString, openBlock, createBlock, createCommentVNode, createTextVNode, useSSRContext } from 'vue';
...
const __nuxt_component_2 = Object.assign(_sfc_main$1, { __name: "CommonSectionCard" });
  ...
  setup(__props, { emit: __emit }) {
    ...
    function cleanPayload(values) {
      ...
      for (const [key, value] of Object.entries(values)) {
        cleaned[key] = value === "" || value === void 0 ? null : value;
      }
      return cleaned;
    }
...
//# sourceMappingURL=ShopForm-99DmI3W_.mjs.map
