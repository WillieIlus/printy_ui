...
import { _ as __nuxt_component_6 } from './FieldHint-i6LQE4WY.mjs';
import { _ as __nuxt_component_4 } from './InlineError-CDgd_EMb.mjs';
import { _ as _sfc_main$4 } from './Textarea-DUPwu95P.mjs';
import { defineComponent, computed, ref, reactive, watch, mergeProps, withCtx, createVNode, unref, openBlock, createBlock, Fragment, renderList, createTextVNode, toDisplayString, useSSRContext } from 'vue';
...
import { b as _sfc_main$9, h as useRuntimeConfig, w as _export_sfc } from './server.mjs';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "space-y-4" }, _attrs))} data-v-5ec17f5a><div data-v-5ec17f5a><label class="mb-1.5 block text-sm font-medium text-[var(--p-text-dim)]" data-v-5ec17f5a>Search location</label><input${ssrRenderAttr("value", unref(searchValue))} type="text" placeholder="Search Westlands, Nairobi" class="w-full rounded-xl border border-[var(--p-border)] bg-[var(--p-surface-sunken)] px-4 py-2.5 text-sm text-[var(--p-text)] placeholder:text-[var(--p-text-muted)] focus:border-amber-500 focus:outline-none focus:ring-1 focus:ring-amber-500" data-v-5ec17f5a><p class="mt-1 text-xs text-[var(--p-text-muted)]" data-v-5ec17f5a> Search for an area, estate, town, or address. Google will suggest places. </p></div>`);
      if (unref(apiKey)) {
        _push(`<div class="h-64 w-full rounded-xl border border-[var(--p-border)] bg-[var(--p-surface-sunken)]" data-v-5ec17f5a></div>`);
      } else {
        _push(`<div class="rounded-xl border border-amber-200/60 bg-amber-50/30 p-4 dark:border-amber-800/40 dark:bg-amber-900/10" data-v-5ec17f5a><p class="text-sm text-amber-700 dark:text-amber-300" data-v-5ec17f5a> Add <code class="rounded bg-amber-200/50 px-1 py-0.5 dark:bg-amber-800/50" data-v-5ec17f5a>NUXT_PUBLIC_GOOGLE_MAPS_API_KEY</code> to enable map search. </p></div>`);
      }
      _push(`<div class="grid grid-cols-1 gap-4 md:grid-cols-2" data-v-5ec17f5a><div data-v-5ec17f5a><label class="mb-1.5 block text-sm font-medium text-[var(--p-text-dim)]" data-v-5ec17f5a>Address</label><input${ssrRenderAttr("value", unref(form).address_line)} class="w-full rounded-xl border border-[var(--p-border)] bg-[var(--p-surface-sunken)] px-4 py-2.5 text-sm text-[var(--p-text)]" data-v-5ec17f5a></div><div data-v-5ec17f5a><label class="mb-1.5 block text-sm font-medium text-[var(--p-text-dim)]" data-v-5ec17f5a>City</label><input${ssrRenderAttr("value", unref(form).city)} class="w-full rounded-xl border border-[var(--p-border)] bg-[var(--p-surface-sunken)] px-4 py-2.5 text-sm text-[var(--p-text)]" data-v-5ec17f5a></div><div data-v-5ec17f5a><label class="mb-1.5 block text-sm font-medium text-[var(--p-text-dim)]" data-v-5ec17f5a>State / County</label><input${ssrRenderAttr("value", unref(form).state)} class="w-full rounded-xl border border-[var(--p-border)] bg-[var(--p-surface-sunken)] px-4 py-2.5 text-sm text-[var(--p-text)]" data-v-5ec17f5a></div><div data-v-5ec17f5a><label class="mb-1.5 block text-sm font-medium text-[var(--p-text-dim)]" data-v-5ec17f5a>Country</label><input${ssrRenderAttr("value", unref(form).country)} class="w-full rounded-xl border border-[var(--p-border)] bg-[var(--p-surface-sunken)] px-4 py-2.5 text-sm text-[var(--p-text)]" data-v-5ec17f5a></div><div data-v-5ec17f5a><label class="mb-1.5 block text-sm font-medium text-[var(--p-text-dim)]" data-v-5ec17f5a>Latitude</label><input${ssrRenderAttr("value", unref(form).latitude)} class="w-full rounded-xl border border-[var(--p-border)] bg-[var(--p-surface-sunken)] px-4 py-2.5 text-sm text-[var(--p-text)]" data-v-5ec17f5a></div><div data-v-5ec17f5a><label class="mb-1.5 block text-sm font-medium text-[var(--p-text-dim)]" data-v-5ec17f5a>Longitude</label><input${ssrRenderAttr("value", unref(form).longitude)} class="w-full rounded-xl border border-[var(--p-border)] bg-[var(--p-surface-sunken)] px-4 py-2.5 text-sm text-[var(--p-text)]" data-v-5ec17f5a></div></div></div>`);
    };
  }
});
...
const __nuxt_component_7 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$1, [["__scopeId", "data-v-5ec17f5a"]]), { __name: "AdminLocationPicker" });
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    function fieldContainerClass(field, extra = "") {
      const hasError = Boolean(fieldError(field));
      return [
        "space-y-2 rounded-2xl border px-4 py-3 transition-colors",
        hasError ? "has-invalid-field border-orange-400/30 bg-orange-500/8 shadow-[0_0_0_1px_rgba(251,146,60,0.16)]" : "border-transparent bg-white/[0.02]",
        extra
      ];
    }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_DashboardFormSection, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="grid gap-5 md:grid-cols-2"${_scopeId}><div class="${ssrRenderClass(fieldContainerClass("name", "md:col-span-2"))}"${_scopeId}><label class="block text-sm font-medium text-white"${_scopeId}>Shop Name</label>`);
            ...
            _push2(`</div><div class="${ssrRenderClass(fieldContainerClass("business_email"))}"${_scopeId}><label class="block text-sm font-medium text-white"${_scopeId}>Business Email</label>`);
            _push2(ssrRenderComponent(_component_UInput, {
            ...
            _push2(`</div><div class="${ssrRenderClass(fieldContainerClass("phone_number"))}"${_scopeId}><label class="block text-sm font-medium text-white"${_scopeId}>Phone / WhatsApp Number</label>`);
            _push2(ssrRenderComponent(_component_UInput, {
            ...
            return [
              createVNode("div", { class: "grid gap-5 md:grid-cols-2" }, [
                createVNode("div", {
                  class: fieldContainerClass("name", "md:col-span-2")
                }, [
                ...
                createVNode("div", {
                  class: fieldContainerClass("business_email")
                }, [
                ...
                createVNode("div", {
                  class: fieldContainerClass("phone_number")
                }, [
      ...
      _push(ssrRenderComponent(_component_DashboardFormSection, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div class="grid gap-5 md:grid-cols-2"${_scopeId}><div class="${ssrRenderClass(fieldContainerClass("state"))}"${_scopeId}><label class="block text-sm font-medium text-white"${_scopeId}>County</label>`);
            _push2(ssrRenderComponent(_component_UInput, {
            ...
            _push2(`</div><div class="${ssrRenderClass(fieldContainerClass("city"))}"${_scopeId}><label class="block text-sm font-medium text-white"${_scopeId}>Town / Area / Estate</label>`);
            _push2(ssrRenderComponent(_component_UInput, {
            ...
            _push2(`</div><div class="${ssrRenderClass(fieldContainerClass("address_line", "md:col-span-2"))}"${_scopeId}><label class="block text-sm font-medium text-white"${_scopeId}>Street / Building / Floor</label>`);
            _push2(ssrRenderComponent(_component_UInput, {
            ...
            _push2(`</div><div class="${ssrRenderClass(fieldContainerClass("zip_code"))}"${_scopeId}><label class="block text-sm font-medium text-white"${_scopeId}>Landmark</label>`);
            _push2(ssrRenderComponent(_component_UInput, {
            ...
            return [
              ...
              createVNode("div", { class: "grid gap-5 md:grid-cols-2" }, [
                createVNode("div", {
                  class: fieldContainerClass("state")
                }, [
                ...
                createVNode("div", {
                  class: fieldContainerClass("city")
                }, [
                ...
                createVNode("div", {
                  class: fieldContainerClass("address_line", "md:col-span-2")
                }, [
                ...
                createVNode("div", {
                  class: fieldContainerClass("zip_code")
                }, [
...
//# sourceMappingURL=ShopForm-CbgPlMMT.mjs.map
