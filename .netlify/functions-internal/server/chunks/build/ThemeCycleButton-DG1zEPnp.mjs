import { b as __nuxt_component_2, a as _sfc_main$f, F as useState } from './server.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_ClientOnly, _attrs, {
        fallback: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<button type="button" class="inline-flex items-center gap-2 rounded-full border border-[var(--p-border)] bg-[var(--p-surface)] px-3 py-2 text-sm font-medium text-[var(--p-text)] shadow-sm" aria-label="Theme menu"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_UIcon, {
              name: "i-lucide-monitor",
              class: "h-4 w-4 shrink-0"
            }, null, _parent2, _scopeId));
            _push2(`<span class="hidden sm:inline"${_scopeId}>Theme</span></button>`);
          } else {
            return [
              createVNode("button", {
                type: "button",
                ...
                createVNode("span", { class: "hidden sm:inline" }, "Theme")
              ])
            ];
          }
        })
...
//# sourceMappingURL=ThemeCycleButton-DG1zEPnp.mjs.map
