...
import { f as useRoute, e as useToast, b as _sfc_main$9, a as _sfc_main$f, m as useNuxtApp, A as API } from './server.mjs';
import { _ as __nuxt_component_4 } from './SkeletonState-BhcHA7h3.mjs';
import { _ as __nuxt_component_4$1 } from './SectionCard-_jwDKQ61.mjs';
import { _ as _sfc_main$4 } from './Badge-Dn_IFHF_.mjs';
import { _ as __nuxt_component_6 } from './RichTextDisplay-CnD11EO8.mjs';
import { _ as _sfc_main$5 } from './Card-euyZbd6S.mjs';
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderTeleport(_push, (_push2) => {
        if (__props.open) {
          _push2(`<div class="fixed inset-0 z-50 flex items-center justify-center p-4" role="dialog" aria-modal="true"><div class="absolute inset-0 bg-black/50 backdrop-blur-sm" aria-hidden></div><div class="modal-panel relative z-[100010] w-full max-w-md rounded-lg border border-[var(--p-border)] bg-[var(--p-surface-raised)] p-5 shadow-lg sm:p-6"><div class="flex items-center justify-between mb-4"><div><h2 class="text-base font-semibold text-[var(--p-text)] sm:text-lg">Share Quote</h2><p class="mt-0.5 text-sm text-[var(--p-text-muted)]"> Copy the link or WhatsApp summary to share with your customer. </p></div><button type="button" class="rounded-md p-1.5 text-[var(--p-text-muted)] transition-colors hover:bg-[var(--p-surface-sunken)] hover:text-[var(--p-text)]" aria-label="Close">`);
...
//# sourceMappingURL=_id_-2i5r3Ope.mjs.map
