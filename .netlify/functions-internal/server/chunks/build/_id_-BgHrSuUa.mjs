...
import { c as formatCurrency, f as formatDate } from './formatters-Cc_7PG6h.mjs';
import { u as useNotification } from './useNotification-DxMfmZhF.mjs';
import { u as useIncomingRequests, a as useSentQuotes } from './useIncomingRequests-D5x3BDeT.mjs';
import '../_/nitro.mjs';
import 'lru-cache';
import '@unocss/core';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const turnaroundDisplay = computed(
      () => latestQuote.value?.turnaround_days != null ? `${latestQuote.value.turnaround_days} business day${latestQuote.value.turnaround_days === 1 ? "" : "s"}` : "Not set"
    );
...
//# sourceMappingURL=_id_-BgHrSuUa.mjs.map
