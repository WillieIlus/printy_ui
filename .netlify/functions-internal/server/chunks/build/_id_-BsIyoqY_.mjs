...
import { _ as _sfc_main$2 } from './FormField-BD4oNIMk.mjs';
import { _ as _sfc_main$3 } from './Textarea-CeohXmxE.mjs';
...
import { a as useJobRequests, b as useJobClaims } from './useJobRequests-CStOb5H3.mjs';
import { u as useAuth } from './useAuth-EV0_qEzl.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    function jobStatusLabel(s) {
      const m = { OPEN: "Open", CLAIMED: "Claimed", CLOSED: "Closed" };
      return m[s] ?? s;
    }
    ...
    function claimStatusLabel(s) {
      const m = { PENDING: "Pending", ACCEPTED: "Accepted", REJECTED: "Rejected" };
      return m[s] ?? s;
    }
      ...
      if (unref(loading) && !unref(job)) {
        ...
        _push(ssrRenderComponent(_component_UBadge, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`${ssrInterpolate(jobStatusLabel(unref(job).status))}`);
            } else {
              return [
                createTextVNode(toDisplayString(jobStatusLabel(unref(job).status)), 1)
              ];
            }
          }),
          _: 1
        ...
        if (unref(isOwner) && (unref(job).claims?.length ?? 0) > 0) {
          ...
          ssrRenderList(unref(job).claims, (c) => {
            ...
            _push(ssrRenderComponent(_component_UBadge, {
              ...
              default: withCtx((_, _push2, _parent2, _scopeId) => {
                if (_push2) {
                  _push2(`${ssrInterpolate(claimStatusLabel(c.status))}`);
                } else {
                  return [
                    createTextVNode(toDisplayString(claimStatusLabel(c.status)), 1)
                  ];
                }
              }),
              _: 2
...
//# sourceMappingURL=_id_-BsIyoqY_.mjs.map
