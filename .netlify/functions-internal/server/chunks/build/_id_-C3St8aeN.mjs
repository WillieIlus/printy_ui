...
import { f as useRoute, b as _sfc_main$9, a as _sfc_main$f, m as useNuxtApp, A as API } from './server.mjs';
...
import { defineComponent, computed, ref, watch, mergeProps, unref, withCtx, createTextVNode, createVNode, toDisplayString, reactive, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderList } from 'vue/server-renderer';
import { i as dashboardFormFieldUi, d as dashboardSelectUi, g as dashboardInputUi } from './formUi-NbOzRwMW.mjs';
import { n as normalizeNumberValue } from './payload-B_6emhZU.mjs';
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_USelectMenu, {
              ...
              "onUpdate:modelValue": ($event) => selectedProductId.value = normalizeOptionalNumber($event)
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(_component_USelectMenu, {
                ...
                class: "w-full",
                ui: unref(dashboardSelectUi),
                "onUpdate:modelValue": ($event) => selectedPaperId.value = normalizeOptionalNumber($event)
              }, null, _parent2, _scopeId));
            } else {
              return [
                createVNode(_component_USelectMenu, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(_component_USelectMenu, {
                ...
                class: "w-full",
                ui: unref(dashboardSelectUi),
                "onUpdate:modelValue": ($event) => selectedMachineId.value = normalizeOptionalNumber($event)
              }, null, _parent2, _scopeId));
            } else {
              return [
                createVNode(_component_USelectMenu, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(_component_USelectMenu, {
                ...
                class: "w-full",
                ui: unref(dashboardSelectUi),
                "onUpdate:modelValue": ($event) => selectedMaterialId.value = normalizeOptionalNumber($event)
              }, null, _parent2, _scopeId));
            } else {
              return [
                createVNode(_component_USelectMenu, {
      ...
      if (unref(product)?.pricing_mode === "SHEET" && unref(canPreview)) {
        ...
        if (unref(calcError)) {
          ...
          if (unref(calcLoading)) {
            ...
            _push(`<span class="text-2xl font-bold text-flamingo-600 dark:text-flamingo-400">${ssrInterpolate(unref(formatMoney)(unref(calcResult).costs.suggested_price))}</span>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div>`);
          if (unref(calcResult) && !unref(calcLoading)) {
            _push(`<div class="grid gap-3 sm:grid-cols-2"><div class="rounded-lg border border-flamingo-200/80 bg-white/70 p-3 dark:border-flamingo-800/40 dark:bg-black/10"><p class="text-[0.68rem] font-semibold uppercase tracking-[0.14em] text-[var(--p-text-muted)]">Pcs per sheet</p><p class="mt-2 text-2xl font-extrabold text-[var(--p-text)]">${ssrInterpolate(unref(calcResult).imposition.per_sheet)}</p><p class="mt-1 text-xs text-[var(--p-text-dim)]">${ssrInterpolate(unref(calcResult).imposition.sheet_size_used)}</p></div><div class="rounded-lg border border-flamingo-200/80 bg-white/70 p-3 dark:border-flamingo-800/40 dark:bg-black/10"><p class="text-[0.68rem] font-semibold uppercase tracking-[0.14em] text-[var(--p-text-muted)]">Sheets required</p><p class="mt-2 text-2xl font-extrabold text-flamingo-600 dark:text-flamingo-400">${ssrInterpolate(unref(calcResult).sheets_required)}</p><p class="mt-1 text-xs text-[var(--p-text-dim)]">Backend imposition result</p></div></div>`);
          } else {
            _push(`<!---->`);
          }
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(loading) && !unref(quote)) {
        ...
        _push(`<p class="mt-3 text-2xl font-bold text-[var(--p-text)]">${ssrInterpolate(unref(quote).total ? unref(formatMoney)(unref(quote).total) : "—")}</p></div></div><div><h2 class="text-lg font-semibold text-[var(--p-text)] mb-4">Items</h2>`);
        if (unref(quote).items?.length) {
          _push(`<div class="space-y-4"><!--[-->`);
          ssrRenderList(unref(quote).items, (item) => {
            _push(`<div class="rounded-xl border border-[var(--p-border)] bg-[var(--p-surface)] p-4"><div class="flex justify-between items-start"><div><p class="font-medium text-[var(--p-text)]">${ssrInterpolate(item.product_name || item.title || "Item")}</p><p class="text-sm text-[var(--p-text-muted)]">${ssrInterpolate(item.quantity)} pcs × ${ssrInterpolate(item.unit_price ? unref(formatMoney)(item.unit_price) : "—")}</p></div><p class="font-semibold text-[var(--p-text)]">${ssrInterpolate(item.line_total ? unref(formatMoney)(item.line_total) : "—")}</p></div></div>`);
          });
          _push(`<!--]--></div>`);
        } else {
...
//# sourceMappingURL=_id_-C3St8aeN.mjs.map
