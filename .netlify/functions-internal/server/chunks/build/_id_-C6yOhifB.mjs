...
import { f as useRoute, c as _sfc_main$9, a as _sfc_main$f, s as useNuxtApp, A as API } from './server.mjs';
...
import { b as formatKES, a as formatDate } from './formatters-C4IR8tCh.mjs';
import { _ as _sfc_main$4 } from './FormField-CCAAD2YO.mjs';
import { _ as _sfc_main$5 } from './SelectMenu-Cud-scqw.mjs';
import { _ as _sfc_main$6 } from './Input-il5BObb7.mjs';
import { _ as _sfc_main$7 } from './Checkbox-BX22gW7J.mjs';
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<details${ssrRenderAttrs(mergeProps({ class: "group" }, _attrs))}><summary class="flex items-center gap-2 cursor-pointer text-sm text-[var(--p-text-muted)] hover:text-[var(--p-text-dim)] list-none">`);
      _push(ssrRenderComponent(_component_UIcon, {
        name: "i-lucide-chevron-right",
        class: "w-4 h-4 transition-transform group-open:rotate-90"
      }, null, _parent));
      _push(` Pricing breakdown </summary><div class="mt-2 pl-6 border-l-2 border-[var(--p-border)]"><div class="space-y-1.5 text-sm">`);
      if (__props.snapshot.paper_label) {
        _push(`<div class="flex justify-between"><span class="text-[var(--p-text-muted)]">Paper</span><span class="text-[var(--p-text)]">${ssrInterpolate(__props.snapshot.paper_label)}</span></div>`);
      } else {
        _push(`<!---->`);
      }
      if (__props.snapshot.paper_cost) {
        _push(`<div class="flex justify-between"><span class="text-[var(--p-text-muted)]">Paper cost</span><span class="text-[var(--p-text)]">${ssrInterpolate(unref(formatKES)(__props.snapshot.paper_cost))}</span></div>`);
      } else {
        _push(`<!---->`);
      }
      if (__props.snapshot.print_cost) {
        _push(`<div class="flex justify-between"><span class="text-[var(--p-text-muted)]">Print</span><span class="text-[var(--p-text)]">${ssrInterpolate(unref(formatKES)(__props.snapshot.print_cost))}</span></div>`);
      } else {
        _push(`<!---->`);
      }
      if (__props.snapshot.material_cost) {
        _push(`<div class="flex justify-between"><span class="text-[var(--p-text-muted)]">Material</span><span class="text-[var(--p-text)]">${ssrInterpolate(unref(formatKES)(__props.snapshot.material_cost))}</span></div>`);
      } else {
        _push(`<!---->`);
      }
      if (__props.snapshot.finishing_total) {
        _push(`<div class="flex justify-between"><span class="text-[var(--p-text-muted)]">Finishing</span><span class="text-[var(--p-text)]">${ssrInterpolate(unref(formatKES)(__props.snapshot.finishing_total))}</span></div>`);
      } else {
        _push(`<!---->`);
      }
      if (__props.snapshot.finishing_lines?.length) {
        _push(`<div class="mt-1 space-y-0.5"><!--[-->`);
        ssrRenderList(__props.snapshot.finishing_lines, (line, i) => {
          _push(`<div class="flex justify-between text-xs pl-2"><span class="text-[var(--p-text-muted)]">${ssrInterpolate(line.name)}</span><span class="text-[var(--p-text-dim)]">${ssrInterpolate(unref(formatKES)(line.computed_cost))}</span></div>`);
        });
        _push(`<!--]--></div>`);
      } else {
        _push(`<!---->`);
      }
      if (__props.snapshot.line_total) {
        _push(`<div class="flex justify-between font-medium pt-2 border-t border-[var(--p-border)]"><span class="text-[var(--p-text)]">Line total</span><span class="text-[var(--p-text)]">${ssrInterpolate(unref(formatKES)(__props.snapshot.line_total))}</span></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div></details>`);
    };
  }
});
...
_sfc_main$2.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/dashboard/quotes/QuoteItemBreakdown.vue");
  return _sfc_setup$2 ? _sfc_setup$2(props, ctx) : void 0;
};
const __nuxt_component_4 = Object.assign(_sfc_main$2, { __name: "DashboardQuotesQuoteItemBreakdown" });
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "rounded-xl border border-[var(--p-border)] bg-[var(--p-surface)] p-4 space-y-4" }, _attrs))}><h3 class="font-semibold text-[var(--p-text)]">Add item</h3><form class="space-y-4">`);
          ...
          if (_push2) {
            ...
            return [
              createVNode(_component_UInput, {
                ...
                placeholder: String(unref(minQty)),
                onBlur: ($event) => unref(form).quantity = Math.max(unref(minQty), unref(form).quantity || unref(minQty))
              }, null, 8, ["modelValue", "onUpdate:modelValue", "min", "placeholder", "onBlur"])
            ];
          }
        }),
        _: 1
      ...
      if (unref(product)?.pricing_mode === "SHEET") {
        _push(`<div class="grid grid-cols-2 gap-4">`);
        _push(ssrRenderComponent(_component_UFormField, { label: "Machine" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(_component_USelectMenu, {
        ...
        _push(ssrRenderComponent(_component_UFormField, { label: "Sides" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(_component_USelectMenu, {
      ...
      if (unref(product)?.pricing_mode === "SHEET") {
        _push(`<div class="grid grid-cols-2 gap-4">`);
        _push(ssrRenderComponent(_component_UFormField, { label: "Color" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(_component_USelectMenu, {
      ...
      if (unref(product)?.pricing_mode === "LARGE_FORMAT") {
        _push(`<div class="grid grid-cols-2 gap-4">`);
        _push(ssrRenderComponent(_component_UFormField, { label: "Material" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(_component_USelectMenu, {
        ...
        _push(ssrRenderComponent(_component_UFormField, { label: "Width (mm)" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(_component_UInput, {
        ...
        _push(ssrRenderComponent(_component_UFormField, { label: "Height (mm)" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(_component_UInput, {
      ...
      if (unref(product)?.pricing_mode === "SHEET" && unref(canPreview)) {
        ...
        if (unref(calcError)) {
          ...
          if (unref(calcResult) && !unref(calcLoading)) {
            _push(`<div class="mt-2 pl-6 border-l-2 border-[var(--p-border)] space-y-1 text-sm"><div class="flex justify-between"><span class="text-[var(--p-text-muted)]">Sheets required</span><span class="text-[var(--p-text)]">${ssrInterpolate(unref(calcResult).sheets_required)}</span></div><div class="flex justify-between"><span class="text-[var(--p-text-muted)]">Paper cost</span><span class="text-[var(--p-text)]">${ssrInterpolate(unref(formatKES)(unref(calcResult).costs.paper_cost))}</span></div><div class="flex justify-between"><span class="text-[var(--p-text-muted)]">Print cost</span><span class="text-[var(--p-text)]">${ssrInterpolate(unref(formatKES)(unref(calcResult).costs.print_cost))}</span></div><div class="flex justify-between"><span class="text-[var(--p-text-muted)]">Finishing</span><span class="text-[var(--p-text)]">${ssrInterpolate(unref(formatKES)(unref(calcResult).costs.finishing_cost))}</span></div></div>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</details><!--]-->`);
...
const __nuxt_component_5 = Object.assign(_sfc_main$1, { __name: "DashboardQuotesQuoteItemAddForm" });
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_DashboardQuotesQuoteItemBreakdown = __nuxt_component_4;
      const _component_DashboardQuotesQuoteItemAddForm = __nuxt_component_5;
      const _component_UIcon = _sfc_main$f;
...
//# sourceMappingURL=_id_-C6yOhifB.mjs.map
