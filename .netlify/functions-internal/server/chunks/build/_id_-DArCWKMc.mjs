...
import { c as formatCurrency } from './formatters-Cc_7PG6h.mjs';
import { updateQuoteDraftFile, downloadQuoteDraftFilePdf, previewQuoteDraftFileWhatsapp, downloadQuoteDraftPdf, requestQuote, getQuoteDraftFile, previewPrice } from './quoteDraft-DMIJySf0.mjs';
      ...
      if (unref(loading) && !unref(activeFile)) {
        ...
        if (unref(activeFile).shop_groups.length) {
          ...
          ssrRenderList(unref(activeFile).shop_groups, (group) => {
            ...
            if (group.latest_sent_quote?.turnaround_days) {
              _push(`<p class="mt-1 text-sm text-[var(--p-text-muted)]"> Turnaround: ${ssrInterpolate(group.latest_sent_quote.turnaround_days)} business day(s) </p>`);
            } else {
              _push(`<!---->`);
            }
...
//# sourceMappingURL=_id_-DArCWKMc.mjs.map
