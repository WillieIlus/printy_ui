...
import { _ as __nuxt_component_1 } from './SentQuoteStatusBadge-Q8oW4Gm0.mjs';
import { _ as __nuxt_component_5 } from './DashboardEmptyState-BX9Z7Yh3.mjs';
import { defineComponent, computed, ref, resolveComponent, mergeProps, unref, withCtx, createVNode, createTextVNode, openBlock, createBlock, toDisplayString, createCommentVNode, Fragment, renderList, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderList, ssrRenderClass } from 'vue/server-renderer';
import { b as formatDate, f as formatCurrency } from './formatters-D5StX5za.mjs';
import { u as useNotification } from './useNotification-Dn_AzVKG.mjs';
import { u as useSentQuotes, a as useIncomingRequests } from './useIncomingRequests-Dkoz_Xi6.mjs';
import '../_/nitro.mjs';
import 'lru-cache';
import '@unocss/core';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(loading) && !unref(quote)) {
        ...
        _push(ssrRenderComponent(_component_SectionCard, null, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              if (unref(quote).turnaround_days != null) {
                _push2(`<div${_scopeId}><p class="text-xs font-medium text-[var(--p-text-muted)]"${_scopeId}>Turnaround</p><p class="text-lg font-medium text-[var(--p-text)]"${_scopeId}>${ssrInterpolate(unref(quote).turnaround_days)} business day${ssrInterpolate(unref(quote).turnaround_days !== 1 ? "s" : "")}</p></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div>`);
              ...
              return [
                ...
                createVNode("div", { class: "mt-4 grid gap-4 sm:grid-cols-2" }, [
                  ...
                  unref(quote).turnaround_days != null ? (openBlock(), createBlock("div", { key: 0 }, [
                    createVNode("p", { class: "text-xs font-medium text-[var(--p-text-muted)]" }, "Turnaround"),
                    createVNode("p", { class: "text-lg font-medium text-[var(--p-text)]" }, toDisplayString(unref(quote).turnaround_days) + " business day" + toDisplayString(unref(quote).turnaround_days !== 1 ? "s" : ""), 1)
              ...
              return [
                createVNode("div", { class: "space-y-2 text-sm" }, [
                  ...
                  createVNode("p", null, [
                    ...
                    createTextVNode(" " + toDisplayString(unref(quote).quote_request_summary?.status || "—"), 1)
                  ])
                ])
              ];
            }
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(ssrRenderComponent(_component_ReviseQuoteForm, {
                  ...
                  "initial-turnaround": unref(quote).turnaround_days,
                  onSubmit: onRevise,
        ...
        if (unref(quote).whatsapp_summary) {
          _push(ssrRenderComponent(_component_SectionCard, { title: "Shareable summary" }, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<p class="text-sm text-[var(--p-text)] whitespace-pre-wrap font-mono"${_scopeId}>${ssrInterpolate(unref(quote).whatsapp_summary)}</p>`);
              } else {
                return [
                  createVNode("p", { class: "text-sm text-[var(--p-text)] whitespace-pre-wrap font-mono" }, toDisplayString(unref(quote).whatsapp_summary), 1)
                ];
              }
            }),
            _: 1
        ...
        _push(ssrRenderComponent(_component_DashboardEmptyState, {
          ...
          description: "This quote may have been removed or you don't have access.",
...
//# sourceMappingURL=_id_-DQWXCkfM.mjs.map
