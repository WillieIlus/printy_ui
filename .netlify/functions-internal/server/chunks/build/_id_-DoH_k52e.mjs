import { f as useRoute, d as _sfc_main$9, a as _sfc_main$f, _ as __nuxt_component_3$1, n as navigateTo } from './server.mjs';
      ...
      if (unref(loading) && !unref(request)) {
        ...
        if (unref(latestQuote)) {
          ...
          if (unref(latestQuote).turnaround_days) {
            ...
            _push(` ${ssrInterpolate(unref(latestQuote).turnaround_days)} business day${ssrInterpolate(unref(latestQuote).turnaround_days === 1 ? "" : "s")}</p>`);
          } else {
            _push(`<!---->`);
          }
...
//# sourceMappingURL=_id_-DoH_k52e.mjs.map
