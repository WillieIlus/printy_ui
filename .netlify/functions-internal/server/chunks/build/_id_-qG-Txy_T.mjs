...
import { _ as __nuxt_component_1 } from './IncomingRequestStatusBadge-BAWU1Wu8.mjs';
...
import { b as formatCurrency } from './formatters-r_qbKRfS.mjs';
import { u as useNotification } from './useNotification-B7Z2gs_7.mjs';
import { a as useIncomingRequests, u as useSentQuotes } from './useIncomingRequests-Chmos0Yy.mjs';
import '../_/nitro.mjs';
import 'lru-cache';
import '@unocss/core';
      ...
      if (unref(loading) && !unref(request)) {
        ...
        if (unref(request).whatsapp_summary) {
          _push(ssrRenderComponent(_component_SectionCard, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<p class="text-sm text-[var(--p-text)] whitespace-pre-wrap font-mono mb-3"${_scopeId}>${ssrInterpolate(unref(request).whatsapp_summary)}</p>`);
                ...
                return [
                  createVNode("p", { class: "text-sm text-[var(--p-text)] whitespace-pre-wrap font-mono mb-3" }, toDisplayString(unref(request).whatsapp_summary), 1),
...
//# sourceMappingURL=_id_-qG-Txy_T.mjs.map
