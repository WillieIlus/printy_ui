...
import { f as useRoute, g as useAnalyticsTracking, _ as __nuxt_component_3$1$1, a as _sfc_main$f, e as useRuntimeConfig } from './server.mjs';
...
import { f as fetchSEOProductDetail } from './seo-Dcr3aNUz.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const trackedSlug = ref(null);
    async function loadProductDetail(productSlug) {
      loading.value = true;
      try {
        categoryFromApi.value = await fetchSEOProductDetail(productSlug);
      } catch {
    ...
    watch(slug, async (newSlug) => {
      if (newSlug) {
        await loadProductDetail(newSlug);
      }
    });
    const products = {
      "business-cards": {
...
//# sourceMappingURL=_slug_-D5saIoIo.mjs.map
