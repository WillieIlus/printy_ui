...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/gallery",
        class: "mt-4 inline-flex items-center rounded-xl bg-[var(--color-primary-600)] px-5 py-2.5 text-sm font-semibold text-white hover:bg-[var(--color-primary-700)] transition-colors"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
      ...
      _push(`</section><section><h2 class="text-xl font-semibold text-[var(--p-text)]">Get started</h2><p class="mt-3 text-gray-600 dark:text-gray-400 leading-relaxed"> Create an account, set up your first shop, and start generating quotes. No long-term commitment required. </p>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/auth/signup",
        class: "mt-4 inline-flex items-center rounded-xl bg-[var(--color-primary-600)] px-5 py-2.5 text-sm font-semibold text-white hover:bg-[var(--color-primary-700)] transition-colors"
      }, {
...
//# sourceMappingURL=about-C0eFTUnf.mjs.map
