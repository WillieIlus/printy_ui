...
import { e as _sfc_main$9, n as navigateTo } from './server.mjs';
import { _ as __nuxt_component_2, a as __nuxt_component_11 } from './InfoCard-K1X9VF5P.mjs';
import { _ as __nuxt_component_3 } from './ShopForm-C9IX-G4S.mjs';
  ...
  setup(__props) {
    ...
    async function onSubmit(data) {
      ...
      try {
        ...
        if (!result.success || !result.shop) {
          notification.error(shopStore.error ?? "We could not create the shop yet. Please check the highlighted fields.");
          return;
        }
        await sellerStore.fetchShops();
        notification.success("Shop created successfully. Next, add machines, papers, and products for this shop.");
        await navigateTo(`/dashboard/shops/${result.shop.slug}/setup`);
      } catch (error) {
        notification.error(error instanceof Error ? error.message : "We could not create the shop yet. Please try again.");
      } finally {
        saving.value = false;
      }
    }
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_DashboardInfoCard, {
        ...
        description: "After you save the shop, Printy will take you into setup so you can add machines, default parent sheets, and the first products.",
        icon: "i-lucide-route",
        tone: "blue"
      }, null, _parent));
      _push(ssrRenderComponent(_component_DashboardInfoCard, {
        title: "Kenyan address examples",
        description: "County: Nairobi County. Town / Area: Westlands. Street / Building: Muthithi Road, Madonna House. Landmark: Opposite Sarit Centre.",
        icon: "i-lucide-map"
      }, null, _parent));
      _push(ssrRenderComponent(_component_DashboardInfoCard, {
        title: "Why location matters",
        description: "A well-entered location improves customer trust, helps delivery riders find the shop faster, and makes marketplace discovery more believable.",
...
//# sourceMappingURL=create-C49xsxjl.mjs.map
