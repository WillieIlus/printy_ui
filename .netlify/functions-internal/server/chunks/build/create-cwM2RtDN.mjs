...
import { f as useRoute, b as _sfc_main$9, n as navigateTo } from './server.mjs';
...
import { _ as _sfc_main$4 } from './Checkbox-COEi3vth.mjs';
import { _ as _sfc_main$5 } from './Alert-BQjQ5uNh.mjs';
...
import { u as useQuoteStore } from './quote-DE6asbXN.mjs';
import { c as normalizeTextValue } from './payload-B_6emhZU.mjs';
import '../_/nitro.mjs';
import 'lru-cache';
import '@unocss/core';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const selectedExample = ref(void 0);
    const form = reactive({
      name: "",
      description: "",
      pricing_mode: "SHEET",
    ...
    function toggleFinishing(optionId) {
    ...
    function fieldError(field) {
      return formFieldErrors.value[field] ?? formFieldErrors.value[`field_errors.${field}`] ?? formFieldErrors.value[`field_errors.${field}.0`] ?? null;
    }
    function fieldClass(field) {
      return fieldError(field) ? "ring-2 ring-orange-400/60 shadow-[0_0_0_8px_rgba(251,146,60,0.08)] animate-[pulse_3s_ease-in-out_infinite]" : "";
    }
    function goBack() {
      ...
      _push(ssrRenderComponent(_component_DashboardFormSection, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_DashboardInlineError, {
              message: fieldError("pricing_mode")
            }, null, _parent2, _scopeId));
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_UInput, {
              ...
              placeholder: "90",
              size: "xl",
              class: fieldClass("default_finished_width_mm")
            }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(_component_DashboardInlineError, {
              message: fieldError("default_finished_width_mm") || unref(errors).finished_width
            }, null, _parent2, _scopeId));
            ...
            _push2(ssrRenderComponent(_component_UInput, {
              ...
              placeholder: "54",
              size: "xl",
              class: fieldClass("default_finished_height_mm")
            }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(_component_DashboardInlineError, {
              message: fieldError("default_finished_height_mm") || unref(errors).finished_height
            }, null, _parent2, _scopeId));
            ...
            _push2(`</div><div class="space-y-2"${_scopeId}><label class="block text-sm font-medium text-white"${_scopeId}>Standard turnaround (working hours)</label>`);
            _push2(ssrRenderComponent(_component_UInput, {
              modelValue: unref(form).standard_turnaround_hours,
              "onUpdate:modelValue": ($event) => unref(form).standard_turnaround_hours = $event,
              type: "number",
              placeholder: "16",
              size: "xl"
            }, null, _parent2, _scopeId));
            _push2(`</div><div class="space-y-2"${_scopeId}><label class="block text-sm font-medium text-white"${_scopeId}>Queue delay (hours)</label>`);
            _push2(ssrRenderComponent(_component_UInput, {
              modelValue: unref(form).queue_hours,
              "onUpdate:modelValue": ($event) => unref(form).queue_hours = $event,
              type: "number",
              min: "0",
              placeholder: "0",
              size: "xl"
            }, null, _parent2, _scopeId));
            _push2(`</div><div class="space-y-2"${_scopeId}><label class="block text-sm font-medium text-white"${_scopeId}>Safety buffer (hours)</label>`);
            _push2(ssrRenderComponent(_component_UInput, {
              modelValue: unref(form).buffer_hours,
              "onUpdate:modelValue": ($event) => unref(form).buffer_hours = $event,
              type: "number",
              min: "0",
              placeholder: "1",
              size: "xl"
            ...
            _push2(ssrRenderComponent(_component_UCheckbox, {
              modelValue: unref(form).rush_available,
              "onUpdate:modelValue": ($event) => unref(form).rush_available = $event
            }, null, _parent2, _scopeId));
            _push2(`<span${_scopeId}>Rush turnaround available</span></label><div class="space-y-2"${_scopeId}><label class="block text-sm font-medium text-white"${_scopeId}>Rush turnaround (working hours)</label>`);
            _push2(ssrRenderComponent(_component_UInput, {
              modelValue: unref(form).rush_turnaround_hours,
              "onUpdate:modelValue": ($event) => unref(form).rush_turnaround_hours = $event,
              type: "number",
              min: "1",
              disabled: !unref(form).rush_available,
              placeholder: "8",
              size: "xl"
            }, null, _parent2, _scopeId));
            _push2(`</div></div>`);
            ...
            return [
              createVNode("div", { class: "grid gap-5 md:grid-cols-2" }, [
                ...
                createVNode("div", { class: "space-y-2" }, [
                  createVNode("label", { class: "block text-sm font-medium text-white" }, "Standard turnaround (working hours)"),
                  createVNode(_component_UInput, {
                    modelValue: unref(form).standard_turnaround_hours,
                    "onUpdate:modelValue": ($event) => unref(form).standard_turnaround_hours = $event,
                    type: "number",
                ...
                createVNode("div", { class: "space-y-2" }, [
                  createVNode("label", { class: "block text-sm font-medium text-white" }, "Queue delay (hours)"),
                  createVNode(_component_UInput, {
                    modelValue: unref(form).queue_hours,
                    "onUpdate:modelValue": ($event) => unref(form).queue_hours = $event,
                    type: "number",
                ...
                createVNode("div", { class: "space-y-2" }, [
                  createVNode("label", { class: "block text-sm font-medium text-white" }, "Safety buffer (hours)"),
                  createVNode(_component_UInput, {
                    modelValue: unref(form).buffer_hours,
                    "onUpdate:modelValue": ($event) => unref(form).buffer_hours = $event,
                    type: "number",
                ...
                createVNode("label", { class: "flex items-center gap-3 rounded-2xl border border-white/10 bg-white/5 px-4 py-3 text-sm text-slate-200" }, [
                  ...
                  createVNode("span", null, "Rush turnaround available")
                ]),
                createVNode("div", { class: "space-y-2" }, [
                  createVNode("label", { class: "block text-sm font-medium text-white" }, "Rush turnaround (working hours)"),
                  createVNode(_component_UInput, {
                    modelValue: unref(form).rush_turnaround_hours,
                    "onUpdate:modelValue": ($event) => unref(form).rush_turnaround_hours = $event,
                    type: "number",
      ...
      _push(ssrRenderComponent(_component_DashboardFormSection, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_DashboardInlineError, {
              message: fieldError("default_sheet_size")
            }, null, _parent2, _scopeId));
            ...
            _push2(ssrRenderComponent(_component_DashboardInlineError, {
              message: fieldError("default_machine")
            }, null, _parent2, _scopeId));
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            ssrRenderList(unref(finishingOptions), (option) => {
              _push2(`<label class="flex items-center gap-3 rounded-2xl border border-white/10 bg-white/5 px-4 py-3 text-sm text-slate-200"${_scopeId}>`);
              _push2(ssrRenderComponent(_component_UCheckbox, {
                "model-value": unref(selectedFinishingIds).includes(option.id),
                "onUpdate:modelValue": ($event) => toggleFinishing(option.id)
              }, null, _parent2, _scopeId));
              _push2(`<span${_scopeId}>${ssrInterpolate(option.name)}</span></label>`);
            });
            _push2(`<!--]--></div>`);
            _push2(ssrRenderComponent(_component_DashboardFieldHint, { text: "Finishing selections are sent to the backend as finishing_rate IDs instead of UI-only labels." }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(_component_DashboardInlineError, {
              message: fieldError("finishing_options")
            }, null, _parent2, _scopeId));
          } else {
            return [
              createVNode("div", { class: "grid gap-2 sm:grid-cols-2" }, [
              ...
              createVNode(_component_DashboardFieldHint, { text: "Finishing selections are sent to the backend as finishing_rate IDs instead of UI-only labels." }),
              createVNode(_component_DashboardInlineError, {
                message: fieldError("finishing_options")
              }, null, 8, ["message"])
            ];
...
//# sourceMappingURL=create-cwM2RtDN.mjs.map
