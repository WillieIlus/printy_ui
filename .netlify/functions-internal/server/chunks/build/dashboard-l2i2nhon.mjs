import { g as useRoute, _ as __nuxt_component_3$1, a as _sfc_main$f, d as _sfc_main$9, b as __nuxt_component_2$1, h as useToast, w as parseApiError } from './server.mjs';
...
import { defineComponent, ref, computed, mergeProps, withCtx, createVNode, unref, toDisplayString, createTextVNode, openBlock, createBlock, createCommentVNode, watch, isRef, withModifiers, Fragment, renderList, useSSRContext } from 'vue';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</header><div class="flex min-h-[calc(100vh-4rem)] flex-1 overflow-hidden min-w-0"><aside class="hidden border-r border-white/10 bg-slate-950/65 backdrop-blur-xl md:flex md:w-[19rem] md:shrink-0 md:flex-col"><nav class="flex flex-1 flex-col gap-6 overflow-y-auto p-4"><div class="overflow-hidden rounded-[30px] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.08),rgba(255,255,255,0.03))] shadow-[0_20px_60px_rgba(15,23,42,0.45)]"><div class="border-b border-white/10 bg-[radial-gradient(circle_at_top_right,rgba(240,82,36,0.2),transparent_45%)] p-4"><div class="flex items-start justify-between gap-3"><div><p class="text-[11px] uppercase tracking-[0.28em] text-slate-400">Current Shop</p><p class="mt-2 text-xs leading-5 text-slate-300"> Machines, paper compatibility, and product setup all flow from the active shop workspace. </p></div><span class="inline-flex items-center gap-1 rounded-full border border-orange-400/20 bg-orange-500/10 px-2.5 py-1 text-[10px] font-semibold uppercase tracking-[0.22em] text-orange-200">`);
      _push(ssrRenderComponent(_component_UIcon, {
        name: "i-lucide-orbit",
        class: "h-3.5 w-3.5"
      }, null, _parent));
      _push(` Live </span></div></div><div class="p-4">`);
      if (unref(activeShop)) {
        _push(`<!--[--><div class="flex items-start gap-3"><div class="flex h-11 w-11 items-center justify-center rounded-2xl border border-orange-400/20 bg-orange-500/10">`);
        _push(ssrRenderComponent(_component_UIcon, {
          name: "i-lucide-store",
          class: "h-5 w-5 text-orange-300"
        }, null, _parent));
        _push(`</div><div class="min-w-0 flex-1"><p class="truncate text-sm font-semibold text-white">${ssrInterpolate(unref(activeShop).name)}</p><p class="truncate text-xs text-slate-400">/${ssrInterpolate(unref(activeShop).slug)}</p><p class="mt-2 text-xs leading-5 text-slate-300">${ssrInterpolate(unref(shopContextLine))}</p></div></div><div class="mt-4 grid grid-cols-2 gap-2"><!--[-->`);
        ssrRenderList(unref(shopContextLinks), (link) => {
          _push(ssrRenderComponent(_component_NuxtLink, {
            key: link.to,
            to: link.to,
            class: ["flex items-center gap-2 rounded-2xl border px-3 py-2.5 text-xs font-medium transition", isActive(link.to) ? "border-orange-400/25 bg-orange-500/14 text-orange-100" : "border-white/10 bg-white/5 text-slate-200 hover:border-white/15 hover:bg-white/8"]
          }, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(ssrRenderComponent(_component_UIcon, {
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<span${_scopeId}>Open shop workspace</span>`);
              _push2(ssrRenderComponent(_component_UIcon, {
              ...
              return [
                createVNode("span", null, "Open shop workspace"),
                createVNode(_component_UIcon, {
                  name: "i-lucide-arrow-up-right",
                  class: "h-4 w-4 text-orange-300"
                })
        ...
        _push(`<!--[--><p class="text-sm leading-6 text-slate-300"> Start by registering your first print shop, then add machines, parent sheets, and products. </p>`);
        _push(ssrRenderComponent(_component_UButton, {
          to: "/dashboard/shops/create",
          color: "primary",
      ...
      _push(`</div></div><div class="space-y-3"><div class="flex items-center justify-between px-2"><p class="text-[11px] font-semibold uppercase tracking-[0.28em] text-slate-500">Quick Actions</p><span class="text-[10px] uppercase tracking-[0.2em] text-slate-600">Fast path</span></div><div class="grid grid-cols-1 gap-2"><!--[-->`);
      ssrRenderList(unref(shortcuts), (shortcut) => {
        _push(ssrRenderComponent(_component_NuxtLink, {
          key: shortcut.label,
          to: shortcut.to,
          class: ["flex items-center gap-3 rounded-2xl border px-3 py-3 text-sm transition", shortcut.emphasis ? "border-orange-400/30 bg-orange-500/12 text-orange-100 shadow-[0_12px_30px_rgba(240,82,36,0.12)] hover:bg-orange-500/18" : "border-white/10 bg-white/5 text-slate-200 hover:bg-white/10"]
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<span class="flex h-9 w-9 items-center justify-center rounded-xl border border-white/10 bg-black/20"${_scopeId}>`);
              _push2(ssrRenderComponent(_component_UIcon, {
                name: shortcut.icon,
                class: "h-4 w-4 shrink-0"
              }, null, _parent2, _scopeId));
              _push2(`</span><div class="min-w-0 flex-1"${_scopeId}><p class="truncate font-medium"${_scopeId}>${ssrInterpolate(shortcut.label)}</p><p class="truncate text-xs text-slate-400"${_scopeId}>${ssrInterpolate(shortcut.description)}</p></div>`);
              _push2(ssrRenderComponent(_component_UIcon, {
                name: "i-lucide-arrow-up-right",
                class: "h-4 w-4 shrink-0"
              }, null, _parent2, _scopeId));
              ...
              return [
                createVNode("span", { class: "flex h-9 w-9 items-center justify-center rounded-xl border border-white/10 bg-black/20" }, [
                  createVNode(_component_UIcon, {
                    name: shortcut.icon,
                    class: "h-4 w-4 shrink-0"
                  }, null, 8, ["name"])
                ...
                createVNode("div", { class: "min-w-0 flex-1" }, [
                  createVNode("p", { class: "truncate font-medium" }, toDisplayString(shortcut.label), 1),
                  createVNode("p", { class: "truncate text-xs text-slate-400" }, toDisplayString(shortcut.description), 1)
                ]),
                createVNode(_component_UIcon, {
                  name: "i-lucide-arrow-up-right",
                  class: "h-4 w-4 shrink-0"
      ...
      ssrRenderList(navGroups, (group) => {
        _push(`<div class="rounded-[26px] border border-white/10 bg-white/[0.04] p-3 shadow-[0_12px_40px_rgba(15,23,42,0.22)]"><div class="flex items-start gap-3 px-1 pb-3"><span class="flex h-10 w-10 items-center justify-center rounded-2xl border border-white/10 bg-black/20">`);
        _push(ssrRenderComponent(_component_UIcon, {
          name: group.icon,
          class: "h-4 w-4 text-slate-200"
        }, null, _parent));
        _push(`</span><div class="min-w-0"><p class="text-[11px] font-semibold uppercase tracking-[0.28em] text-slate-500">${ssrInterpolate(group.label)}</p><p class="mt-1 text-xs leading-5 text-slate-400">${ssrInterpolate(group.helper)}</p></div></div><!--[-->`);
        ssrRenderList(group.items, (item) => {
          _push(ssrRenderComponent(_component_NuxtLink, {
            key: `${group.label}-${item.label}`,
            to: item.to,
            class: ["mt-1 flex items-center justify-between rounded-2xl px-3 py-2.5 text-sm transition", isActive(item.to) ? "border border-orange-400/25 bg-orange-500/12 text-orange-100 shadow-[0_12px_30px_rgba(240,82,36,0.12)]" : "border border-transparent text-slate-300 hover:border-white/10 hover:bg-white/6"]
          }, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<span class="flex min-w-0 items-center gap-3"${_scopeId}><span class="relative flex h-9 w-9 shrink-0 items-center justify-center rounded-xl border border-white/10 bg-black/20"${_scopeId}>`);
                _push2(ssrRenderComponent(_component_UIcon, {
                  name: item.icon,
                  class: "h-4 w-4 shrink-0"
                }, null, _parent2, _scopeId));
                ...
                _push2(`</span><span class="min-w-0"${_scopeId}><span class="block truncate font-medium"${_scopeId}>${ssrInterpolate(item.label)}</span><span class="block truncate text-xs text-slate-500"${_scopeId}>${ssrInterpolate(item.description)}</span></span></span>`);
                _push2(ssrRenderComponent(_component_UIcon, {
                ...
                return [
                  createVNode("span", { class: "flex min-w-0 items-center gap-3" }, [
                    createVNode("span", { class: "relative flex h-9 w-9 shrink-0 items-center justify-center rounded-xl border border-white/10 bg-black/20" }, [
                      createVNode(_component_UIcon, {
                        name: item.icon,
                        class: "h-4 w-4 shrink-0"
                      }, null, 8, ["name"]),
                    ...
                    createVNode("span", { class: "min-w-0" }, [
                      createVNode("span", { class: "block truncate font-medium" }, toDisplayString(item.label), 1),
                      createVNode("span", { class: "block truncate text-xs text-slate-500" }, toDisplayString(item.description), 1)
                    ])
                  ]),
                  createVNode(_component_UIcon, {
                    name: "i-lucide-chevron-right",
      ...
      _push(`<!--]--></div><div class="space-y-3"><div class="flex items-center justify-between px-2"><p class="text-[11px] font-semibold uppercase tracking-[0.28em] text-slate-500">My Shops</p>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/dashboard/shops",
        class: "text-[11px] font-medium text-orange-300 transition hover:text-orange-200"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` View all `);
...
//# sourceMappingURL=dashboard-l2i2nhon.mjs.map
