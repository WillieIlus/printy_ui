import { l as _export_sfc, u as useAuthStore, _ as __nuxt_component_3$1, a as _sfc_main$f, b as __nuxt_component_2$1 } from './server.mjs';
import { _ as __nuxt_component_1$1, a as __nuxt_component_2 } from './PrintyWordmark-D2LPDI6W.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<footer${ssrRenderAttrs(mergeProps({
    ...
    style: { "font-family": "var(--font-body)" }
  }, _attrs))}><div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8"><div class="mb-10">`);
  _push(ssrRenderComponent(_component_HomeFooterLinks, null, null, _parent));
  _push(`</div><div class="flex flex-col items-center justify-between gap-4 border-t border-gray-700 pt-8 sm:flex-row"><div class="flex items-center gap-3"><div class="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg overflow-hidden" style="${ssrRenderStyle({ "background": "#e13515" })}">`);
...
//# sourceMappingURL=default-BjK9uKuY.mjs.map
