import { O as _export_sfc, c as useAuthStore, _ as __nuxt_component_3$1, a as _sfc_main$f, b as __nuxt_component_2$1 } from './server.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(mobileOpen)) {
        ...
        if (!unref(authStore).isAuthenticated) {
          ...
          _push(ssrRenderComponent(_component_NuxtLink, {
            to: "/auth/signup",
            class: "group inline-flex items-center justify-center gap-2 rounded-xl bg-flamingo-500 px-4 py-2.5 text-center text-sm font-semibold text-white transition-colors hover:bg-flamingo-400",
            onClick: ($event) => mobileOpen.value = false
          }, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
...
//# sourceMappingURL=default-DmPE8Mx4.mjs.map
