import { F as _export_sfc, c as useAuthStore, _ as __nuxt_component_3$1, b as __nuxt_component_2$1, a as _sfc_main$f, G as useState } from './server.mjs';
import { _ as __nuxt_component_1$1, a as __nuxt_component_2 } from './PrintyWordmark-D0Sy8EK8.mjs';
import { _ as __nuxt_component_4 } from './ThemeCycleButton-DDbLSOKu.mjs';
import { defineComponent, computed, mergeProps, unref, ref, withCtx, createVNode, toDisplayString, createTextVNode, watch, useSSRContext } from 'vue';
...
import { u as useUserStore } from './user-B3ceVEvf.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<footer${ssrRenderAttrs(mergeProps({
    class: "relative overflow-hidden bg-[var(--p-bg)] border-t border-[var(--p-border)] py-12 text-[var(--p-text-muted)] sm:py-16",
    style: { "font-family": "var(--font-body)" }
...
//# sourceMappingURL=default-h3Y-DHo0.mjs.map
