...
import { defineComponent, ref, computed, mergeProps, withCtx, createTextVNode, createVNode, unref, openBlock, createBlock, toDisplayString, createCommentVNode, useSSRContext } from 'vue';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_DashboardFormSection, {
        ...
        description: "Name, role, language, phone, address, bio, avatar, and social links are supported here through the live account API."
      }, {
...
//# sourceMappingURL=edit-BWUGxpYm.mjs.map
