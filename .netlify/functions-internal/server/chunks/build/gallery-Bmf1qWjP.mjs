import { e as useToast, b as _sfc_main$9, K as __nuxt_component_5, a as _sfc_main$f, q as usePublicApiNoAuth, _ as __nuxt_component_1$1, n as navigateTo } from './server.mjs';
...
import { _ as _sfc_main$4 } from './Badge-Dn_IFHF_.mjs';
...
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderList, ssrInterpolate, ssrRenderAttr, ssrRenderClass, ssrIncludeBooleanAttr, ssrLooseEqual, ssrRenderSlot } from 'vue/server-renderer';
import { _ as _sfc_main$5 } from './Input-Hudv-7BP.mjs';
import { _ as _sfc_main$6 } from './Checkbox-COEi3vth.mjs';
import { _ as _sfc_main$7 } from './Textarea-DUPwu95P.mjs';
import { a as getGalleryProductOptions, c as calculateGalleryProductPrice } from './gallery-DpmXPp8_.mjs';
import { getActiveDraft, tweakAndAdd } from './quoteDraft-5mvcgeM-.mjs';
...
const __nuxt_component_1 = Object.assign(_sfc_main$3, { __name: "QuotesQuoteConfigSection" });
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const toneClasses = computed(() => {
      ...
      return "border-flamingo-200 bg-flamingo-50 text-flamingo-800 dark:border-flamingo-800 dark:bg-flamingo-950/30 dark:text-flamingo-200";
    });
    const iconToneClasses = computed(() => {
      ...
      return "bg-flamingo-100 text-flamingo-700 dark:bg-flamingo-900/50 dark:text-flamingo-200";
    });
...
const __nuxt_component_7 = Object.assign(_sfc_main$2, { __name: "QuotesQuoteConfigNotice" });
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    if (pricingMode.value === "SHEET") {
                      _push3(`<div class="grid gap-5 lg:grid-cols-2"${_scopeId2}><div${_scopeId2}><label class="mb-1.5 block text-sm font-medium text-[var(--p-text-dim)]"${_scopeId2}>Sides</label><div class="grid grid-cols-2 gap-2"${_scopeId2}><button type="button" class="${ssrRenderClass([form.sides === "SIMPLEX" ? "border-[var(--color-primary-400)] bg-[var(--color-primary-50)] text-[var(--color-primary-700)] dark:bg-[var(--color-primary-900)]/20" : "border-[var(--p-border)] text-[var(--p-text-dim)]", "rounded-lg border px-3 py-2 text-sm font-medium transition-all"])}"${_scopeId2}> One side </button><button type="button" class="${ssrRenderClass([form.sides === "DUPLEX" ? "border-[var(--color-primary-400)] bg-[var(--color-primary-50)] text-[var(--color-primary-700)] dark:bg-[var(--color-primary-900)]/20" : "border-[var(--p-border)] text-[var(--p-text-dim)]", "rounded-lg border px-3 py-2 text-sm font-medium transition-all"])}"${_scopeId2}> Both sides </button></div></div></div>`);
                    } else {
                      _push3(`<!---->`);
                    }
                    if (pricingMode.value === "SHEET" && machines.value.length) {
                      ...
                      ssrRenderList(machines.value, (m) => {
                        _push3(`<label class="${ssrRenderClass([form.machine === m.id ? "bg-[var(--color-primary-50)] dark:bg-[var(--color-primary-900)]/20" : "hover:bg-[var(--p-surface-sunken)]", "flex items-center gap-3 rounded-lg px-3 py-2 transition-colors"])}"${_scopeId2}><input${ssrIncludeBooleanAttr(ssrLooseEqual(form.machine, m.id)) ? " checked" : ""} type="radio"${ssrRenderAttr("value", m.id)} class="accent-[var(--color-primary-500)]"${_scopeId2}><span class="text-sm text-[var(--p-text)]"${_scopeId2}>${ssrInterpolate(m.name)}</span></label>`);
                      });
                      _push3(`<!--]--></div></div>`);
                    } else {
                      _push3(`<!---->`);
                    ...
                    if (pricingMode.value === "SHEET" && papers.value.length) {
                      ...
                      ssrRenderList(papers.value, (p) => {
                        _push3(`<label class="${ssrRenderClass([form.paper === p.id ? "bg-[var(--color-primary-50)] dark:bg-[var(--color-primary-900)]/20" : "hover:bg-[var(--p-surface-sunken)]", "flex items-center gap-3 rounded-lg px-3 py-2 transition-colors"])}"${_scopeId2}><input${ssrIncludeBooleanAttr(ssrLooseEqual(form.paper, p.id)) ? " checked" : ""} type="radio"${ssrRenderAttr("value", p.id)} class="accent-[var(--color-primary-500)]"${_scopeId2}><span class="text-sm text-[var(--p-text)]"${_scopeId2}>${ssrInterpolate(p.sheet_size)} ${ssrInterpolate(p.gsm)}gsm ${ssrInterpolate(p.paper_type)}</span></label>`);
                      });
                      _push3(`<!--]--></div></div>`);
                    } else {
                      _push3(`<!---->`);
                    ...
                    if (pricingMode.value === "LARGE_FORMAT" && materials.value.length) {
                      ...
                      ssrRenderList(materials.value, (m) => {
                        _push3(`<label class="${ssrRenderClass([form.material === m.id ? "bg-[var(--color-primary-50)] dark:bg-[var(--color-primary-900)]/20" : "hover:bg-[var(--p-surface-sunken)]", "flex items-center gap-3 rounded-lg px-3 py-2 transition-colors"])}"${_scopeId2}><input${ssrIncludeBooleanAttr(ssrLooseEqual(form.material, m.id)) ? " checked" : ""} type="radio"${ssrRenderAttr("value", m.id)} class="accent-[var(--color-primary-500)]"${_scopeId2}><span class="text-sm text-[var(--p-text)]"${_scopeId2}>${ssrInterpolate(m.material_type ?? "Material")}</span></label>`);
                      });
                      _push3(`<!--]--></div></div>`);
                    } else {
                      _push3(`<!---->`);
                        ...
                        pricingMode.value === "SHEET" ? (openBlock(), createBlock("div", {
                          ...
                          createVNode("div", null, [
                            ...
                            createVNode("div", { class: "grid grid-cols-2 gap-2" }, [
                              createVNode("button", {
                                type: "button",
                                class: ["rounded-lg border px-3 py-2 text-sm font-medium transition-all", form.sides === "SIMPLEX" ? "border-[var(--color-primary-400)] bg-[var(--color-primary-50)] text-[var(--color-primary-700)] dark:bg-[var(--color-primary-900)]/20" : "border-[var(--p-border)] text-[var(--p-text-dim)]"],
                                onClick: ($event) => form.sides = "SIMPLEX"
                              }, " One side ", 10, ["onClick"]),
                              createVNode("button", {
                                type: "button",
                                class: ["rounded-lg border px-3 py-2 text-sm font-medium transition-all", form.sides === "DUPLEX" ? "border-[var(--color-primary-400)] bg-[var(--color-primary-50)] text-[var(--color-primary-700)] dark:bg-[var(--color-primary-900)]/20" : "border-[var(--p-border)] text-[var(--p-text-dim)]"],
                                onClick: ($event) => form.sides = "DUPLEX"
                              }, " Both sides ", 10, ["onClick"])
                            ])
                          ])
                        ])) : createCommentVNode("", true),
                          ...
                          createVNode("div", { class: "space-y-1.5 rounded-xl border border-[var(--p-border)] bg-[var(--p-surface)] p-2" }, [
                            (openBlock(true), createBlock(Fragment, null, renderList(machines.value, (m) => {
                              return openBlock(), createBlock("label", {
                                key: m.id,
                                class: ["flex items-center gap-3 rounded-lg px-3 py-2 transition-colors", form.machine === m.id ? "bg-[var(--color-primary-50)] dark:bg-[var(--color-primary-900)]/20" : "hover:bg-[var(--p-surface-sunken)]"]
                              }, [
                        ...
                        pricingMode.value === "SHEET" && papers.value.length ? (openBlock(), createBlock("div", { key: 2 }, [
                          ...
                          createVNode("div", { class: "space-y-1.5 rounded-xl border border-[var(--p-border)] bg-[var(--p-surface)] p-2" }, [
                            (openBlock(true), createBlock(Fragment, null, renderList(papers.value, (p) => {
                              return openBlock(), createBlock("label", {
                                key: p.id,
                                class: ["flex items-center gap-3 rounded-lg px-3 py-2 transition-colors", form.paper === p.id ? "bg-[var(--color-primary-50)] dark:bg-[var(--color-primary-900)]/20" : "hover:bg-[var(--p-surface-sunken)]"]
                              }, [
                                withDirectives(createVNode("input", {
                        ...
                        pricingMode.value === "LARGE_FORMAT" && materials.value.length ? (openBlock(), createBlock("div", { key: 3 }, [
                          ...
                          createVNode("div", { class: "space-y-1.5 rounded-xl border border-[var(--p-border)] bg-[var(--p-surface)] p-2" }, [
                            (openBlock(true), createBlock(Fragment, null, renderList(materials.value, (m) => {
                              return openBlock(), createBlock("label", {
                                key: m.id,
                                class: ["flex items-center gap-3 rounded-lg px-3 py-2 transition-colors", form.material === m.id ? "bg-[var(--color-primary-50)] dark:bg-[var(--color-primary-900)]/20" : "hover:bg-[var(--p-surface-sunken)]"]
                              }, [
                                withDirectives(createVNode("input", {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    if (calculating.value) {
                      ...
                      _push3(`<div class="rounded-xl border border-[var(--color-primary-200)]/70 bg-[var(--color-primary-50)]/70 p-4 dark:border-[var(--color-primary-800)]/40 dark:bg-[var(--color-primary-900)]/10"${_scopeId2}>`);
                      if (productionDetails.value.piecesPerSheet || productionDetails.value.sheetsNeeded) {
                        _push3(`<div class="mb-4 grid gap-3 sm:grid-cols-2"${_scopeId2}><div class="rounded-xl border border-[var(--color-primary-200)] bg-[var(--p-surface)] p-3"${_scopeId2}><p class="text-[0.68rem] font-semibold uppercase tracking-[0.14em] text-[var(--p-text-muted)]"${_scopeId2}>Pcs per sheet</p><p class="mt-2 text-lg font-extrabold text-[var(--p-text)]"${_scopeId2}>${ssrInterpolate(productionDetails.value.piecesPerSheet)}</p></div><div class="rounded-xl border border-[var(--color-primary-200)] bg-[var(--p-surface)] p-3"${_scopeId2}><p class="text-[0.68rem] font-semibold uppercase tracking-[0.14em] text-[var(--p-text-muted)]"${_scopeId2}>Sheets needed</p><p class="mt-2 text-lg font-extrabold text-[var(--color-primary-600)] dark:text-[var(--color-primary-400)]"${_scopeId2}>${ssrInterpolate(productionDetails.value.sheetsNeeded)}</p></div></div>`);
                      } else {
                        _push3(`<!---->`);
                      }
                      _push3(`<div class="flex items-baseline justify-between gap-4"${_scopeId2}><span class="font-semibold text-[var(--p-text)]"${_scopeId2}>Estimated total</span><span class="text-xl font-bold text-[var(--color-primary-600)] dark:text-[var(--color-primary-400)]"${_scopeId2}>${ssrInterpolate(unref(formatMoney)(totalPrice.value))}</span></div>`);
                      if (isDemoMode.value) {
                    ...
                    return [
                      createVNode("div", { class: "space-y-3" }, [
                        calculating.value ? (openBlock(), createBlock("div", {
                          ...
                          key: 1,
                          class: "rounded-xl border border-[var(--color-primary-200)]/70 bg-[var(--color-primary-50)]/70 p-4 dark:border-[var(--color-primary-800)]/40 dark:bg-[var(--color-primary-900)]/10"
                        }, [
                          productionDetails.value.piecesPerSheet || productionDetails.value.sheetsNeeded ? (openBlock(), createBlock("div", {
                            key: 0,
                            class: "mb-4 grid gap-3 sm:grid-cols-2"
                          }, [
                            createVNode("div", { class: "rounded-xl border border-[var(--color-primary-200)] bg-[var(--p-surface)] p-3" }, [
                              createVNode("p", { class: "text-[0.68rem] font-semibold uppercase tracking-[0.14em] text-[var(--p-text-muted)]" }, "Pcs per sheet"),
                              createVNode("p", { class: "mt-2 text-lg font-extrabold text-[var(--p-text)]" }, toDisplayString(productionDetails.value.piecesPerSheet), 1)
                            ]),
                            createVNode("div", { class: "rounded-xl border border-[var(--color-primary-200)] bg-[var(--p-surface)] p-3" }, [
                              createVNode("p", { class: "text-[0.68rem] font-semibold uppercase tracking-[0.14em] text-[var(--p-text-muted)]" }, "Sheets needed"),
                              createVNode("p", { class: "mt-2 text-lg font-extrabold text-[var(--color-primary-600)] dark:text-[var(--color-primary-400)]" }, toDisplayString(productionDetails.value.sheetsNeeded), 1)
                            ])
                          ])) : createCommentVNode("", true),
                          createVNode("div", { class: "flex items-baseline justify-between gap-4" }, [
                            ...
                            createVNode("span", { class: "text-xl font-bold text-[var(--color-primary-600)] dark:text-[var(--color-primary-400)]" }, toDisplayString(unref(formatMoney)(totalPrice.value)), 1)
                          ]),
...
//# sourceMappingURL=gallery-Bmf1qWjP.mjs.map
