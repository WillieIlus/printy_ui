...
import { g as useRoute, d as _sfc_main$9 } from './server.mjs';
import { _ as __nuxt_component_4 } from './SkeletonState-BhcHA7h3.mjs';
import { _ as _sfc_main$2 } from './Card-HKq-lRAa.mjs';
import { _ as _sfc_main$3 } from './FormField-BD4oNIMk.mjs';
import { _ as _sfc_main$4 } from './Input-C16lzpZD.mjs';
import { _ as _sfc_main$5 } from './Checkbox-Cm9Vi01u.mjs';
...
import { u as useShopStore$1 } from './shop-DxJ2bD36.mjs';
import '../_/nitro.mjs';
import 'lru-cache';
import '@unocss/core';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_UCard, _attrs, {
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex items-center justify-between"${_scopeId}><h3 class="text-lg font-semibold text-gray-900 dark:text-white"${_scopeId}>Business hours</h3>`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<p class="text-sm text-gray-600 dark:text-gray-400"${_scopeId}> Configure opening hours per day. 1=Monday .. 7=Sunday (ISO). Opening time HH:MM (e.g. 08:00). Closing time HH:MM (e.g. 18:00). </p>`);
            if (__props.hours?.length) {
              _push2(`<div class="mt-4 space-y-2"${_scopeId}><!--[-->`);
              ssrRenderList(unref(localHours), (h, i) => {
                _push2(`<div class="flex flex-col sm:flex-row sm:items-center gap-2 rounded-lg border dark:border-gray-700 px-3 py-2"${_scopeId}><span class="font-medium text-gray-900 dark:text-white shrink-0 w-28"${_scopeId}>${ssrInterpolate(h.weekday_display ?? dayLabel(h.weekday))}</span>`);
                if (unref(editing) && __props.editable) {
                  ...
                  _push2(`<span class="text-sm"${_scopeId}>Closed</span></label><!--]-->`);
                } else {
                  _push2(`<span class="text-sm text-gray-600 dark:text-gray-400"${_scopeId}>${ssrInterpolate(h.is_closed ? "Closed" : `${formatTime(h.from_hour)} – ${formatTime(h.to_hour)}`)}</span>`);
                }
                _push2(`</div>`);
              });
              _push2(`<!--]--></div>`);
            ...
            return [
              createVNode("p", { class: "text-sm text-gray-600 dark:text-gray-400" }, " Configure opening hours per day. 1=Monday .. 7=Sunday (ISO). Opening time HH:MM (e.g. 08:00). Closing time HH:MM (e.g. 18:00). "),
              __props.hours?.length ? (openBlock(), createBlock("div", {
                ...
                (openBlock(true), createBlock(Fragment, null, renderList(unref(localHours), (h, i) => {
                  return openBlock(), createBlock("div", {
                    ...
                    createVNode("span", { class: "font-medium text-gray-900 dark:text-white shrink-0 w-28" }, toDisplayString(h.weekday_display ?? dayLabel(h.weekday)), 1),
                    unref(editing) && __props.editable ? (openBlock(), createBlock(Fragment, { key: 0 }, [
                      ...
                      createVNode("label", { class: "flex items-center gap-2 shrink-0" }, [
                        ...
                        createVNode("span", { class: "text-sm" }, "Closed")
                      ])
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(loading)) {
        ...
        _push(ssrRenderComponent(_component_ShopsShopHours, {
          ...
          onSaved: ($event) => unref(shopStore).fetchShopHoursList(unref(slug))
        }, null, _parent));
        _push(`</div>`);
      }
      _push(`</div>`);
...
//# sourceMappingURL=hours-AVS5Mewk.mjs.map
