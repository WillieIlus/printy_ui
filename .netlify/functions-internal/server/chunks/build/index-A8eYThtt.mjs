...
import { _ as __nuxt_component_6$1 } from './AdminWorkspaceFormPanel-D166ogpE.mjs';
import { F as Form, _ as __nuxt_component_2 } from './FormInput-CXwkCB6L.mjs';
import { _ as _sfc_main$4 } from './Alert-BD7KCbft.mjs';
import { _ as __nuxt_component_4$1 } from './FormSelect-WoeVYZuO.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "relative space-y-6" }, _attrs))}><div class="pointer-events-none absolute inset-x-0 top-0 -z-10 h-72 bg-[radial-gradient(circle_at_top_left,rgba(103,232,249,0.16),transparent_38%),radial-gradient(circle_at_top_right,rgba(96,165,250,0.14),transparent_30%)] blur-2xl"></div>`);
      _push(ssrRenderComponent(_component_DashboardPageHeader, {
        ...
        actions: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_UButton, {
              color: "primary",
              class: "softui-pill-input border-0 !bg-cyan-300/14 px-4 text-cyan-100",
      ...
      if (!unref(loading) && !unref(pricingStore).hasPricing) {
        _push(`<div class="softui-card rounded-[1.9rem] p-5 text-amber-50"><div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between"><div><p class="text-sm font-semibold text-amber-100">Setup incomplete</p><p class="mt-1 text-sm leading-6 text-amber-50/80"> Pricing is still missing. You can load starter defaults, then refine them section by section. </p></div>`);
        _push(ssrRenderComponent(_component_UButton, {
          loading: unref(seedLoading),
          color: "primary",
          class: "softui-pill-input border-0 !bg-amber-300/18 px-4 text-amber-50",
...
//# sourceMappingURL=index-A8eYThtt.mjs.map
