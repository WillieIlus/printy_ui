import { d as useAuthStore, g as useAnalyticsTracking, a as _sfc_main$f, b as _sfc_main$9, c as __nuxt_component_2, _ as __nuxt_component_1, h as useRuntimeConfig, s as safeLogError } from './server.mjs';
import { _ as __nuxt_component_3 } from './LoadingSpinner-DC3DKYaG.mjs';
import { _ as __nuxt_component_5 } from './ShopStatusBadge-1GLjQN6D.mjs';
...
import { g as getRatingSummary } from './ratings-DT0xG04r.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    computed(() => Boolean(config.public.googleMapsApiKey));
    const filterChips = [
    ...
    computed(
      () => filteredShops.value.filter((shop) => typeof shop.latitude === "number" && typeof shop.longitude === "number").map((shop) => ({
        id: shop.id,
        name: shop.name,
        slug: shop.slug,
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_ShopsShopStatusBadge = __nuxt_component_5;
...
//# sourceMappingURL=index-B6kspsAb.mjs.map
