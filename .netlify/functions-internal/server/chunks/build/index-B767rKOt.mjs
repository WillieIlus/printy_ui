import { _ as __nuxt_component_0$1 } from './DashboardPageHeader-Cmi_LCe-.mjs';
...
import { _ as _sfc_main$3 } from './Card-euyZbd6S.mjs';
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_UCard, mergeProps({ class: "transition-shadow hover:shadow-lg" }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (__props.product.description) {
              _push2(`<p class="line-clamp-2 text-sm text-gray-600 dark:text-gray-400"${_scopeId}>${ssrInterpolate(__props.product.description)}</p>`);
            } else {
              _push2(`<!---->`);
            }
            if (unref(priceLabel)) {
...
const __nuxt_component_0 = Object.assign(_sfc_main$2, { __name: "ProductsProductCard" });
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      const _component_ProductsProductCard = __nuxt_component_0;
      ...
      if (__props.products?.length) {
        ...
        ssrRenderList(__props.products, (product) => {
          _push(ssrRenderComponent(_component_ProductsProductCard, {
            key: product.id,
            product
          }, {
            actions: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                ssrRenderSlot(_ctx.$slots, "card-actions", { product }, null, _push2, _parent2, _scopeId);
              } else {
                return [
                  renderSlot(_ctx.$slots, "card-actions", { product })
                ];
              }
            }),
            _: 2
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/products/ProductList.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const __nuxt_component_4 = Object.assign(_sfc_main$1, { __name: "ProductsProductList" });
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_ProductsProductList = __nuxt_component_4;
      ...
      if (unref(quoteStore).loading || !unref(quoteStore).productsLoaded) {
        ...
        _push(ssrRenderComponent(_component_ProductsProductList, {
          products: unref(quoteStore).products
        }, {
...
//# sourceMappingURL=index-B767rKOt.mjs.map
