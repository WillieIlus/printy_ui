import { d as useAuthStore, a as _sfc_main$f, e as _sfc_main$9, _ as __nuxt_component_3$1$1 } from './server.mjs';
import { _ as __nuxt_component_3 } from './LoadingSpinner-DC3DKYaG.mjs';
import { _ as __nuxt_component_4 } from './ShopStatusBadge-CfSWMESb.mjs';
import { u as useFavoritesStore, _ as __nuxt_component_3$1 } from './ShopFavoriteToggle-BpHGydQK.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(filterChips, (chip) => {
        _push(`<button type="button" class="${ssrRenderClass([unref(activeFilter) === chip.value ? "bg-[var(--p-primary)] text-white shadow-lg shadow-[var(--p-primary)]/20" : "bg-[var(--p-surface-container)] text-[var(--p-text-muted)] hover:bg-[var(--p-surface-container-high)] hover:text-[var(--p-text)]", "rounded-full px-5 py-2.5 text-sm font-semibold transition-all"])}">${ssrInterpolate(chip.label)}</button>`);
      });
      ...
      if (unref(loading)) {
        ...
        ssrRenderList(unref(filteredShops), (shop) => {
          ...
          if (shop.rating) {
            _push(`<div class="absolute right-4 top-4 flex items-center gap-1 rounded-full bg-white/92 px-3 py-1 shadow-sm backdrop-blur-md">`);
            _push(ssrRenderComponent(_component_UIcon, {
              name: "i-lucide-star",
...
//# sourceMappingURL=index-BBtIU0Om.mjs.map
