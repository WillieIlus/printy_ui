...
import { a as useIncomingRequests } from './useIncomingRequests-Dkoz_Xi6.mjs';
import '../_/nitro.mjs';
import 'lru-cache';
import '@unocss/core';
  ...
  setup(__props) {
    ...
    const emptyTitle = computed(() => {
      if (statusFilter.value === "all" && !requests.value.length) {
        return "No incoming requests yet";
      }
      return "No requests in this status";
    });
    const emptyDescription = computed(() => {
      if (statusFilter.value === "all" && !requests.value.length) {
        return "When customers submit quote requests to your shop, they will appear here.";
      }
...
//# sourceMappingURL=index-BKBwhybK.mjs.map
