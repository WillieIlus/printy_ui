...
import { d as useAuthStore, b as _sfc_main$9, a as _sfc_main$f, n as navigateTo } from './server.mjs';
...
import { defineComponent, ref, computed, mergeProps, withCtx, unref, createVNode, createTextVNode, openBlock, createBlock, toDisplayString, createCommentVNode, Fragment, renderList, useSSRContext } from 'vue';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_DashboardPageHeader, {
        title: "Profile",
        subtitle: "Manage your account details, profile image, and public-facing links from one reliable profile workspace."
      }, {
...
//# sourceMappingURL=index-BTJtc069.mjs.map
