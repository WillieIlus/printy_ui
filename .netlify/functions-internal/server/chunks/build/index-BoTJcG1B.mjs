import { c as _sfc_main$9, a as _sfc_main$f, _ as __nuxt_component_3$1$1 } from './server.mjs';
...
import { u as useQuoteRequests } from './useQuoteRequests-CW2ZV9om.mjs';
import '../_/nitro.mjs';
import 'lru-cache';
import '@unocss/core';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const emptyDescription = computed(() => {
      if (statusFilter.value === "all" && !requests.value.length) {
        return "Browse a print shop, add products to your draft, and submit a request. Shop responses will appear here.";
      }
...
//# sourceMappingURL=index-BoTJcG1B.mjs.map
