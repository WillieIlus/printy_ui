import { _ as __nuxt_component_3$1, a as _sfc_main$f, b as __nuxt_component_2$2, u as useAsyncData } from './server.mjs';
...
import { _ as __nuxt_component_2$1 } from './PublicCalculator-7GJGXk0j.mjs';
import { g as getAllProducts } from './gallery-CWXZbZWT.mjs';
...
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</h1><p class="mt-5 text-lg leading-relaxed text-[var(--p-text-dim)]">${ssrInterpolate(props.subheadline)}</p><div class="mt-8 flex flex-col sm:flex-row gap-4">`);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_QuotesPublicCalculator = __nuxt_component_2$1;
...
//# sourceMappingURL=index-BrXWu-Tb.mjs.map
