import { _ as __nuxt_component_0$1 } from './DashboardPageHeader-By409uiV.mjs';
...
import { _ as _sfc_main$3 } from './Card-CXU7vIvE.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(quoteStore).loading || !unref(quoteStore).productTemplatesLoaded) {
...
//# sourceMappingURL=index-C54b5EnF.mjs.map
