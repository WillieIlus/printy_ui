...
import { e as useToast, g as useAnalyticsTracking, b as _sfc_main$9, K as __nuxt_component_5, a as _sfc_main$f, _ as __nuxt_component_1$1 } from './server.mjs';
import { _ as __nuxt_component_3$2 } from './LoadingSpinner-DC3DKYaG.mjs';
import { _ as __nuxt_component_3$3 } from './EmptyState-CeDSO_D4.mjs';
import { _ as _sfc_main$1 } from './Badge-Dn_IFHF_.mjs';
import { _ as _sfc_main$1$1, a as __nuxt_component_8 } from './GalleryProductDetailModal-FYQFSH82.mjs';
import { _ as __nuxt_component_9, u as useProductPriceDisplay } from './ProductTweakModal-EHKZZOYs.mjs';
import { defineComponent, ref, computed, mergeProps, withCtx, createVNode, unref, createTextVNode, toDisplayString, openBlock, createBlock, createCommentVNode, withModifiers, isRef, nextTick, useSSRContext } from 'vue';
...
import './quoteDraft-DCmPR0Tc.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_CommonEmptyState = __nuxt_component_3$3;
      ...
      if (unref(loading)) {
        ...
        _push(ssrRenderComponent(_component_CommonEmptyState, {
          ...
          description: unref(fetchError) ? "Something went wrong while loading products." : "Check back later for new products.",
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              return [
                unref(fetchError) ? (openBlock(), createBlock(_component_UButton, {
                  key: 0,
                  color: "primary",
                  onClick: fetchProducts
                }, {
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              return [
                createTextVNode(" Send custom request "),
                createVNode(_component_UIcon, {
                  name: "i-lucide-send",
                  class: "h-4 w-4"
                })
...
//# sourceMappingURL=index-CJ_QmYNc.mjs.map
