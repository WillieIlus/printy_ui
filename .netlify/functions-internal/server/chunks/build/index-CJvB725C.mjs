...
import { _ as __nuxt_component_3$1, a as _sfc_main$f, c as _sfc_main$9 } from './server.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_DashboardPageHeader, {
        title: unref(user)?.first_name ? `Welcome back, ${unref(user).first_name}` : "Print Dashboard",
            ...
            if (_push2) {
              _push2(ssrRenderComponent(_component_UButton, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`Create your first print shop`);
                  } else {
                    return [
                      createTextVNode("Create your first print shop")
                    ];
                  }
                }),
                _: 1
...
//# sourceMappingURL=index-CJvB725C.mjs.map
