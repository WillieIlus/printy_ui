...
import { u as useNotificationsStore, a as useNotifications } from './notifications-GhmUBzyU.mjs';
import '../_/nitro.mjs';
import 'lru-cache';
import '@unocss/core';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(loading) && !unref(notifications).length) {
...
//# sourceMappingURL=index-CQTGGG_d.mjs.map
