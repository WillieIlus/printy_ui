...
import { _ as _sfc_main$3 } from './Card-BjVoYgK3.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.quotes?.length) {
        ...
        _push(ssrRenderComponent(_component_DashboardEmptyState, {
          ...
          description: "Quote requests from customers will appear here. Send quotes to respond.",
...
//# sourceMappingURL=index-DB_6r2L9.mjs.map
