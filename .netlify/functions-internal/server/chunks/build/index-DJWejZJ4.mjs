import { _ as __nuxt_component_3$1, a as _sfc_main$f, b as __nuxt_component_2$1, u as useAsyncData, c as usePublicApi, A as API } from './server.mjs';
import { defineComponent, mergeProps, withCtx, createTextVNode, toDisplayString, createVNode, withAsyncContext, computed, unref, openBlock, createBlock, createCommentVNode, Fragment, renderList, useSSRContext } from 'vue';
...
import { g as getRatingSummary } from './ratings-Bf7x_h_C.mjs';
import { g as getAllProducts } from './gallery-wJMq2SzO.mjs';
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLink = __nuxt_component_3$1;
      const _component_UIcon = _sfc_main$f;
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "bg-[var(--p-surface)] py-16 sm:py-24" }, _attrs))}><div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8"><div class="mb-10 flex flex-col gap-4 md:flex-row md:items-end md:justify-between"><div class="max-w-2xl"><span class="text-[0.6875rem] font-semibold uppercase tracking-[0.14em] text-[var(--p-primary)]"> Popular Products </span><h2 class="mt-3 text-3xl font-bold tracking-tight text-[var(--p-text)] sm:text-4xl"> Live catalog products, presented with a cleaner corporate edge </h2><p class="mt-3 text-base leading-7 text-[var(--p-text-muted)]"> This section now pulls from real product and shop data, while staying close to the tonal stitch layout. </p></div>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/gallery",
      ...
      ssrRenderList(unref(productCards), (product) => {
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="flex h-full flex-col justify-between rounded-xl bg-[var(--p-surface-sunken)] p-8"${_scopeId}><div${_scopeId}><div class="mb-8 flex h-14 w-14 items-center justify-center rounded-xl bg-white shadow-sm transition-transform duration-300 group-hover:scale-105"${_scopeId}>`);
              _push2(ssrRenderComponent(_component_UIcon, {
                name: product.icon,
                class: "h-7 w-7 text-[var(--p-primary)]"
              }, null, _parent2, _scopeId));
              _push2(`</div><h3 class="text-2xl font-bold tracking-tight text-[var(--p-text)]"${_scopeId}>${ssrInterpolate(product.title)}</h3><p class="mt-2 text-sm leading-6 text-[var(--p-text-muted)]"${_scopeId}>${ssrInterpolate(product.description)}</p><div class="mt-4 flex items-center gap-3 text-xs text-[var(--p-text-muted)]"${_scopeId}><span class="font-medium text-[var(--p-text)]"${_scopeId}>${ssrInterpolate(product.shopName)}</span>`);
              ...
              _push2(`<!--]--></div></div><div class="mt-8 flex items-center justify-between border-t border-white/50 pt-4"${_scopeId}><div${_scopeId}><p class="text-[10px] font-bold uppercase tracking-[0.18em] text-[var(--p-text-muted)]"${_scopeId}>Starting from</p><p class="mt-1 text-xl font-extrabold text-[var(--p-text)]"${_scopeId}>${ssrInterpolate(product.priceLabel)}</p><p class="mt-1 text-xs text-[var(--p-text-muted)]"${_scopeId}>${ssrInterpolate(product.deliveryLabel)}</p></div><span class="flex h-12 w-12 items-center justify-center rounded-full bg-[var(--p-primary)] text-white transition-transform group-hover:translate-x-0.5"${_scopeId}>`);
              _push2(ssrRenderComponent(_component_UIcon, {
                name: "i-lucide-arrow-right",
                class: "h-5 w-5"
              }, null, _parent2, _scopeId));
              ...
              return [
                createVNode("div", { class: "flex h-full flex-col justify-between rounded-xl bg-[var(--p-surface-sunken)] p-8" }, [
                  createVNode("div", null, [
                    createVNode("div", { class: "mb-8 flex h-14 w-14 items-center justify-center rounded-xl bg-white shadow-sm transition-transform duration-300 group-hover:scale-105" }, [
                      createVNode(_component_UIcon, {
                        name: product.icon,
                        class: "h-7 w-7 text-[var(--p-primary)]"
                      }, null, 8, ["name"])
                    ]),
                    createVNode("h3", { class: "text-2xl font-bold tracking-tight text-[var(--p-text)]" }, toDisplayString(product.title), 1),
                  ...
                  createVNode("div", { class: "mt-8 flex items-center justify-between border-t border-white/50 pt-4" }, [
                    createVNode("div", null, [
                      ...
                      createVNode("p", { class: "mt-1 text-xl font-extrabold text-[var(--p-text)]" }, toDisplayString(product.priceLabel), 1),
                      createVNode("p", { class: "mt-1 text-xs text-[var(--p-text-muted)]" }, toDisplayString(product.deliveryLabel), 1)
                    ]),
                    createVNode("span", { class: "flex h-12 w-12 items-center justify-center rounded-full bg-[var(--p-primary)] text-white transition-transform group-hover:translate-x-0.5" }, [
                      createVNode(_component_UIcon, {
                        name: "i-lucide-arrow-right",
                        class: "h-5 w-5"
                      })
      ...
      _push(`</div></div></div></div></div><section class="mt-20"><div class="mb-8 flex flex-col gap-4 md:flex-row md:items-end md:justify-between"><div class="max-w-2xl"><span class="text-[0.6875rem] font-semibold uppercase tracking-[0.14em] text-[var(--p-primary)]"> Quote-Ready Shops </span><h3 class="mt-3 text-3xl font-bold tracking-tight text-[var(--p-text)]">Nearby quote opportunities from active shops</h3><p class="mt-3 text-base leading-7 text-[var(--p-text-muted)]"> This borrows the stronger quote-card structure from the stitch references, but uses live shop and product records. </p></div>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/shops",
        class: "inline-flex items-center gap-2 self-start rounded-xl border border-[var(--p-border)] bg-[var(--p-surface-sunken)] px-4 py-2.5 text-sm font-semibold text-[var(--p-text)] transition-colors hover:bg-[var(--p-surface)]"
      }, {
      ...
      ssrRenderList(unref(quoteCards), (quote) => {
        _push(`<div class="rounded-xl border border-[var(--p-border)] bg-[var(--p-surface)] p-6 shadow-[0px_20px_40px_rgba(20,27,44,0.04)] transition-colors hover:bg-[var(--p-surface-sunken)]"><div class="mb-6 flex items-start justify-between gap-4"><div class="flex h-12 w-12 items-center justify-center rounded-lg bg-[var(--p-surface-container)]">`);
        _push(ssrRenderComponent(_component_UIcon, {
          name: quote.icon,
          class: "h-6 w-6 text-[var(--p-primary)]"
        }, null, _parent));
        ...
        _push(`<div class="mt-5 space-y-3"><div class="flex items-center justify-between text-sm"><span class="text-[var(--p-text-muted)]">Estimated Price</span><span class="font-bold text-[var(--p-text)]">${ssrInterpolate(quote.priceLabel)}</span></div><div class="flex items-center justify-between text-sm"><span class="text-[var(--p-text-muted)]">Delivery Time</span><span class="flex items-center gap-1 font-medium text-[var(--p-text)]">`);
        _push(ssrRenderComponent(_component_UIcon, {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(locations, (loc) => {
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="flex h-full flex-col rounded-xl bg-[var(--p-surface-sunken)] p-6"${_scopeId}><div class="flex items-start justify-between gap-4"${_scopeId}><div class="flex h-12 w-12 items-center justify-center rounded-xl bg-white shadow-sm"${_scopeId}>`);
              _push2(ssrRenderComponent(_component_UIcon, {
                name: loc.icon,
                class: "h-6 w-6 text-[var(--p-primary)]"
              }, null, _parent2, _scopeId));
              ...
              return [
                createVNode("div", { class: "flex h-full flex-col rounded-xl bg-[var(--p-surface-sunken)] p-6" }, [
                  createVNode("div", { class: "flex items-start justify-between gap-4" }, [
                    createVNode("div", { class: "flex h-12 w-12 items-center justify-center rounded-xl bg-white shadow-sm" }, [
                      createVNode(_component_UIcon, {
                        name: loc.icon,
                        class: "h-6 w-6 text-[var(--p-primary)]"
                      }, null, 8, ["name"])
                  ...
                  createVNode("div", { class: "mt-8 flex items-center justify-between border-t border-white/50 pt-4" }, [
                    ...
                    createVNode("span", { class: "flex h-11 w-11 items-center justify-center rounded-full bg-[var(--p-primary)] text-white transition-transform group-hover:translate-x-0.5" }, [
                      createVNode(_component_UIcon, {
                        name: "i-lucide-arrow-right",
                        class: "h-5 w-5"
                      })
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLink = __nuxt_component_3$1;
      const _component_UIcon = _sfc_main$f;
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "bg-[var(--p-surface)] py-16 sm:py-24" }, _attrs))}><div class="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8"><div class="overflow-hidden rounded-3xl bg-[var(--p-text)] text-white"><div class="relative grid gap-8 p-8 sm:p-10 lg:grid-cols-[1.1fr_0.9fr] lg:p-14"><div class="absolute right-0 top-0 h-48 w-48 rounded-full bg-white/10 blur-3xl"></div><div class="relative z-10"><span class="inline-flex rounded-full bg-white/10 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.12em] text-white/80"> For Print Shops </span><h2 class="mt-5 text-3xl font-extrabold tracking-tight sm:text-4xl"> Manage requests, quotes, revisions, and production from one place </h2><p class="mt-4 max-w-2xl text-base leading-7 text-slate-300"> Set up your catalog, respond to incoming requests faster, track accepted quotes, and keep the team aligned on turnaround. </p><div class="mt-8 flex flex-col gap-4 sm:flex-row">`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: __props.primaryCtaTo,
        class: "inline-flex items-center justify-center gap-2 rounded-xl bg-white px-6 py-3.5 text-sm font-bold text-[var(--p-text)] transition-colors hover:bg-slate-100"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(__props.primaryCtaLabel)} `);
      ...
      ssrRenderList(highlights, (item) => {
        _push(`<div class="rounded-2xl border border-white/10 bg-white/5 p-5"><div class="flex h-12 w-12 items-center justify-center rounded-xl bg-white/10">`);
        _push(ssrRenderComponent(_component_UIcon, {
          name: item.icon,
...
//# sourceMappingURL=index-DJWejZJ4.mjs.map
