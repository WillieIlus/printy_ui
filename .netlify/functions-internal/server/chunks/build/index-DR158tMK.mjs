import { e as useAuthStore, c as _sfc_main$9, a as _sfc_main$f } from './server.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(loading)) {
        ...
        ssrRenderList(unref(shops), (shop) => {
          ...
          _push(`</div><div class="min-w-0"><h2 class="text-lg font-semibold text-stone-800 dark:text-stone-100 truncate">${ssrInterpolate(shop.name)}</h2>`);
...
//# sourceMappingURL=index-DR158tMK.mjs.map
