      ...
      if (unref(loading) && unref(tab) !== "claims") {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(ssrRenderComponent(_component_UButton, {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`Browse open jobs`);
                    } else {
                      return [
                        createTextVNode("Browse open jobs")
                      ];
                    }
                  }),
                  _: 1
        ...
        ssrRenderList(unref(displayJobs), (job) => {
          ...
          _push(ssrRenderComponent(_component_UBadge, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`${ssrInterpolate(jobStatusLabel(job.status))}`);
              } else {
                return [
                  createTextVNode(toDisplayString(jobStatusLabel(job.status)), 1)
                ];
              }
            }),
            _: 2
        ...
        _push(ssrRenderComponent(_component_DashboardEmptyState, {
          ...
          description: unref(tab) === "open" ? "Open jobs from other shops will appear here. Create your own to share overflow work." : "Create a job request to share overflow work with other shops.",
...
//# sourceMappingURL=index-DSK_0StH.mjs.map
