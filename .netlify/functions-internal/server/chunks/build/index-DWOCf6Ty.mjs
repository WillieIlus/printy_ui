...
import { _ as __nuxt_component_1$1 } from './IncomingRequestStatusBadge-Cy3uXAqB.mjs';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_IncomingRequestStatusBadge = __nuxt_component_1$1;
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const statusTabs = [
      { value: "all", label: "All" },
      { value: "new", label: "New" },
      { value: "messages", label: "Messages / Replies" },
      { value: "actions", label: "Pending actions" },
...
//# sourceMappingURL=index-DWOCf6Ty.mjs.map
