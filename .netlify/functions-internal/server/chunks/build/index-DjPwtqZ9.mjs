...
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))}><div class="absolute inset-0 opacity-20"><div class="absolute -left-8 top-0 h-72 w-72 rounded-full bg-flamingo-500 mix-blend-multiply opacity-70 blur-xl filter animate-pulse"></div><div class="absolute -right-6 top-6 h-72 w-72 rounded-full bg-orange-400 mix-blend-multiply opacity-60 blur-xl filter animate-pulse animation-delay-2000"></div><div class="absolute bottom-0 left-24 h-72 w-72 rounded-full bg-mirage-500 mix-blend-multiply opacity-70 blur-xl filter animate-pulse animation-delay-4000"></div></div><div class="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8"><div class="lg:grid lg:grid-cols-2 lg:items-center lg:gap-12"><div class="max-w-xl self-center"><h1 class="max-w-[11.6ch] text-[clamp(3.65rem,12vw,5.3rem)] font-extrabold leading-[0.9] tracking-[-0.055em] text-white sm:max-w-[11.8ch] sm:text-[clamp(4.55rem,8vw,6.3rem)] lg:max-w-[12ch] lg:text-[clamp(5.5rem,7vw,7.1rem)]">`);
      if (heroHeadline.value.leading) {
        _push(`<!--[--><span class="block max-w-full">${ssrInterpolate(heroHeadline.value.leading)}</span><span class="mt-2.5 block w-[100%] max-w-[8.4ch] text-[1em] font-black leading-[0.92] tracking-[-0.06em] text-flamingo-500 sm:mt-3 sm:max-w-[8.8ch]">${ssrInterpolate(heroHeadline.value.trailing)}</span><!--]-->`);
      } else {
        _push(`<!--[-->${ssrInterpolate(props.headline)}<!--]-->`);
      }
      _push(`</h1><p class="mt-5 text-lg leading-relaxed text-gray-300">${ssrInterpolate(props.subheadline)}</p><div class="mt-8 flex flex-col sm:flex-row gap-4">`);
      ...
      _push(`</div></div><div class="mt-12 lg:mt-0 lg:self-center">`);
...
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_UIcon = _sfc_main$f;
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "border-t border-[var(--p-border)] bg-[var(--p-surface)] py-16 sm:py-24" }, _attrs))}><div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8"><div class="mx-auto max-w-2xl text-center"><span class="text-[0.6875rem] font-semibold uppercase tracking-[0.14em] text-[var(--p-primary)]"> Why Printy </span><h2 class="mt-3 text-3xl font-bold tracking-tight text-[var(--p-text)] sm:text-4xl"> Solve the common print buying friction first </h2><p class="mt-3 text-base leading-7 text-[var(--p-text-muted)]"> Printy removes the parts of buying print that usually waste time before a shop can even respond. </p></div><div class="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-4"><!--[-->`);
      ssrRenderList(features, (feature) => {
        _push(`<article class="rounded-2xl border border-[var(--p-border)] bg-[var(--p-bg)] p-6 shadow-sm"><div class="flex h-10 w-10 items-center justify-center rounded-lg bg-flamingo-100 text-flamingo-600 dark:bg-flamingo-900/30 dark:text-flamingo-400">`);
        _push(ssrRenderComponent(_component_UIcon, {
          name: feature.icon,
          class: "h-5 w-5"
        }, null, _parent));
        _push(`</div><p class="mt-4 text-[11px] font-semibold uppercase tracking-[0.14em] text-[var(--p-text-muted)]">${ssrInterpolate(feature.problem)}</p><h3 class="mt-2 text-lg font-semibold text-[var(--p-text)]">${ssrInterpolate(feature.solution)}</h3><p class="mt-2 text-sm leading-6 text-[var(--p-text-muted)]">${ssrInterpolate(feature.body)}</p></article>`);
      });
...
const __nuxt_component_2 = Object.assign(_sfc_main$5, { __name: "HomeWhyPrinty" });
...
const __nuxt_component_3 = Object.assign(_sfc_main$4, { __name: "HomePopularProducts" });
...
const __nuxt_component_4 = Object.assign(_sfc_main$3, { __name: "HomePopularLocations" });
...
const __nuxt_component_5 = Object.assign(_sfc_main$2, { __name: "HomeHowItWorks" });
...
const __nuxt_component_6 = Object.assign(_sfc_main$1, { __name: "HomeShopOwnerCTA" });
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_HomeWhyPrinty = __nuxt_component_2;
      const _component_HomePopularProducts = __nuxt_component_3;
      const _component_HomePopularLocations = __nuxt_component_4;
      const _component_HomeHowItWorks = __nuxt_component_5;
      const _component_HomeShopOwnerCTA = __nuxt_component_6;
...
//# sourceMappingURL=index-DjPwtqZ9.mjs.map
