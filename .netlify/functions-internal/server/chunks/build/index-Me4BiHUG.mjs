...
import { g as useRoute, c as useAuthStore, i as useToast, h as useAnalyticsTracking, _ as __nuxt_component_3$1, a as _sfc_main$f, d as _sfc_main$9, H as __nuxt_component_5$1, e as useRuntimeConfig, f as usePublicApi, A as API } from './server.mjs';
import { u as useFavoritesStore, _ as __nuxt_component_3$2 } from './ShopFavoriteToggle-fsoaFo9O.mjs';
import { _ as __nuxt_component_4 } from './ShopStatusBadge-BSjl5Vu1.mjs';
...
import { _ as _sfc_main$6 } from './Textarea-CeohXmxE.mjs';
import { r as rateShop } from './ratings-CAkUkeXu.mjs';
import { _ as _sfc_main$7 } from './FormField-BD4oNIMk.mjs';
import { _ as _sfc_main$8 } from './Input-C16lzpZD.mjs';
import { _ as _sfc_main$a } from './SelectMenu-CJtBgKsS.mjs';
import { _ as _sfc_main$b } from './Checkbox-Cm9Vi01u.mjs';
...
import { listQuoteRequests } from './quoteDraft-BhhNn4oA.mjs';
import { u as useApi } from './useApi-4DUqRt-r.mjs';
import { u as usePrintySeo } from './usePrintySeo-CD37Ix9J.mjs';
import '../_/nitro.mjs';
import 'lru-cache';
import '@unocss/core';
...
import './Badge-xP9ZTQag.mjs';
import './gallery-GtLUt84g.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(loading)) {
        ...
        _push(`<!--[--><section class="overflow-hidden rounded-[2rem] border border-sky-200/70 bg-white/80 shadow-[0_32px_90px_-52px_rgba(8,24,52,0.42)] backdrop-blur-xl dark:border-slate-800 dark:bg-slate-950/90"><div class="border-b border-sky-100/80 bg-[linear-gradient(135deg,rgba(8,24,52,0.98),rgba(13,37,73,0.94) 48%,rgba(16,64,116,0.92) 100%)] px-6 py-6 text-white dark:border-slate-800 sm:px-8"><div class="grid gap-6 lg:grid-cols-[minmax(0,1.6fr)_minmax(20rem,0.95fr)]"><div class="min-w-0"><div class="mb-4 flex flex-wrap items-center gap-2 text-[11px] font-semibold uppercase tracking-[0.18em] text-sky-100/70">`);
        ...
        _push(`</div><p class="mt-2 max-w-2xl text-sm leading-6 text-sky-100/78"> Configure a real product, review pricing signals, and send the job to this shop with the same workflow used elsewhere in Printy. </p></div></div><div class="mt-4 flex flex-wrap items-center gap-2">`);
        ...
        _push(`<span class="inline-flex items-center gap-2 rounded-full border border-orange-300/25 bg-orange-500/18 px-3 py-1 text-xs font-medium text-orange-50">`);
        _push(ssrRenderComponent(_component_UIcon, {
        ...
        if (unref(catalog).shop.description) {
          _push(`<div class="mt-5 rounded-2xl border border-white/10 bg-white/8 p-4 backdrop-blur-sm"><p class="mb-2 text-[11px] font-semibold uppercase tracking-[0.18em] text-sky-100/68"> Shop overview </p>`);
          _push(ssrRenderComponent(_component_EditorRichTextDisplay, {
            html: unref(catalog).shop.description,
            class: "text-sm leading-6 text-sky-50/88"
          }, null, _parent));
          _push(`</div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div><div class="space-y-4"><div class="rounded-[1.75rem] border border-white/12 bg-white/10 p-5 shadow-[0_24px_50px_-36px_rgba(2,6,23,0.96)] backdrop-blur-md"><p class="text-[11px] font-semibold uppercase tracking-[0.18em] text-sky-100/68"> Quick actions </p><div class="mt-4 space-y-3">`);
        ...
        _push(ssrRenderComponent(_component_UButton, {
          variant: "outline",
          color: "neutral",
          class: "w-full justify-between rounded-2xl border-white/15 bg-slate-950/28 text-white hover:bg-slate-950/40",
        ...
        ssrRenderList(unref(shopStats), (stat) => {
          _push(`<div class="rounded-[1.5rem] border border-white/12 bg-slate-950/26 p-4 backdrop-blur-sm"><div class="flex items-center gap-3"><div class="flex h-10 w-10 items-center justify-center rounded-2xl bg-orange-500 text-white">`);
          _push(ssrRenderComponent(_component_UIcon, {
            name: stat.icon,
            class: "h-4.5 w-4.5"
          }, null, _parent));
          _push(`</div><div><p class="text-[11px] font-semibold uppercase tracking-[0.16em] text-sky-100/68">${ssrInterpolate(stat.label)}</p><p class="mt-1 text-base font-semibold text-white">${ssrInterpolate(stat.value)}</p></div></div></div>`);
        });
        _push(`<!--]--></div></div></div></div><div class="px-6 py-6 sm:px-8"><div class="flex flex-wrap items-end justify-between gap-4"><div><p class="text-[11px] font-semibold uppercase tracking-[0.18em] text-sky-700/80 dark:text-sky-300/80"> Catalog </p><h2 class="mt-2 text-2xl font-bold tracking-tight text-slate-950 dark:text-white"> Configure a product and send it to this shop </h2><p class="mt-2 max-w-2xl text-sm leading-6 text-slate-600 dark:text-slate-300"> Each card carries real product data from the shop. Open one to tweak quantity, paper, finishing, and other quote options. </p></div><div class="inline-flex items-center gap-2 rounded-full border border-sky-200 bg-sky-50 px-4 py-2 text-xs font-medium text-sky-800 dark:border-sky-800 dark:bg-sky-950/40 dark:text-sky-200">`);
        _push(ssrRenderComponent(_component_UIcon, {
        ...
        if (unref(catalog).products.length) {
          ...
          ssrRenderList(unref(catalog).products, (product) => {
            _push(`<article class="group overflow-hidden rounded-[1.8rem] border border-sky-100 bg-white shadow-[0_24px_60px_-40px_rgba(15,23,42,0.28)] transition-all hover:-translate-y-1.5 hover:border-orange-200 hover:shadow-[0_30px_70px_-42px_rgba(249,115,22,0.34)] dark:border-slate-800 dark:bg-slate-900"><button class="block w-full text-left" type="button"><div class="relative aspect-[4/3] overflow-hidden bg-[linear-gradient(140deg,#d9e8fb_0%,#eef5ff_40%,#ffe2cb_100%)] dark:bg-[linear-gradient(135deg,#0f172a_0%,#102746_62%,#1c3552_100%)]">`);
            ...
            _push(`</div></div></button><div class="space-y-4 p-5"><div><h3 class="text-lg font-semibold tracking-tight text-slate-950 dark:text-slate-100">${ssrInterpolate(product.name)}</h3><p class="mt-2 text-sm leading-6 text-slate-600 dark:text-slate-300">${ssrInterpolate(productCardDescription(product))}</p></div><div class="flex flex-wrap gap-2">`);
            ...
            _push(`</div><div class="grid grid-cols-1 gap-2 text-xs text-slate-600 dark:text-slate-300">`);
            if (product.final_size) {
              _push(`<div class="flex items-center gap-2 rounded-2xl border border-sky-100 bg-sky-50/70 px-3 py-2 dark:border-slate-800 dark:bg-slate-950/60">`);
              _push(ssrRenderComponent(_component_UIcon, {
                name: "i-lucide-ruler",
            ...
            if (product.finishing_summary?.length) {
              ...
              ssrRenderList(product.finishing_summary, (finish) => {
                _push(`<span class="inline-flex items-center rounded-full border border-sky-100 bg-white px-3 py-1 text-[11px] font-medium text-slate-700 dark:border-slate-700 dark:bg-slate-950/70 dark:text-slate-200">${ssrInterpolate(finish)}</span>`);
              });
              _push(`<!--]--></div>`);
            } else {
              _push(`<!---->`);
          ...
          _push(`<div class="mt-6 rounded-[1.8rem] border border-dashed border-sky-200 bg-sky-50/70 p-12 text-center dark:border-slate-700 dark:bg-slate-950/60"><div class="mx-auto flex h-16 w-16 items-center justify-center rounded-3xl bg-white text-sky-900 shadow-sm dark:bg-slate-900 dark:text-slate-100">`);
          _push(ssrRenderComponent(_component_UIcon, {
            name: "i-lucide-package",
            class: "h-8 w-8"
          }, null, _parent));
          _push(`</div><h3 class="mt-4 text-lg font-semibold text-slate-950 dark:text-slate-100">No products yet</h3><p class="mt-2 text-sm text-slate-600 dark:text-slate-300">This shop has not published products to its public catalog yet.</p></div>`);
        }
        _push(`</div></section>`);
        if (unref(pricingStore).rateCard) {
          _push(`<section class="mt-8"><div class="rounded-[1.8rem] border border-sky-100 bg-white/85 p-6 shadow-[0_24px_60px_-42px_rgba(15,23,42,0.26)] dark:border-slate-800 dark:bg-slate-900/90">`);
        ...
        _push(`<div class="rounded-[1.8rem] border border-sky-100 bg-white/90 p-12 text-center shadow-[0_24px_60px_-42px_rgba(15,23,42,0.26)] dark:border-slate-800 dark:bg-slate-900/90"><div class="mx-auto flex h-16 w-16 items-center justify-center rounded-3xl bg-sky-100 text-sky-900 dark:bg-slate-800 dark:text-slate-100">`);
        _push(ssrRenderComponent(_component_UIcon, {
          name: "i-lucide-store",
          class: "h-8 w-8"
        }, null, _parent));
        _push(`</div><h3 class="mt-4 text-lg font-semibold text-slate-950 dark:text-slate-100">Shop not found</h3><p class="mt-2 text-sm text-slate-600 dark:text-slate-300">The shop you are looking for does not exist or is inactive.</p>`);
        _push(ssrRenderComponent(_component_UButton, {
          to: "/shops",
...
//# sourceMappingURL=index-Me4BiHUG.mjs.map
