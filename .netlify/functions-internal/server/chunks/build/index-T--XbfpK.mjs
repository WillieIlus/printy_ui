...
import { e as useRoute, c as _sfc_main$9, a as _sfc_main$f, _ as __nuxt_component_3$1 } from './server.mjs';
...
import { defineComponent, computed, ref, mergeProps, withCtx, unref, createVNode, createTextVNode, toDisplayString, openBlock, createBlock, Fragment, createCommentVNode, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderList, ssrInterpolate } from 'vue/server-renderer';
import { f as formatCurrency, b as formatDate } from './formatters-D5StX5za.mjs';
import { _ as __nuxt_component_5 } from './DashboardEmptyState-BX9Z7Yh3.mjs';
import { u as useSentQuotes } from './useIncomingRequests-Dkoz_Xi6.mjs';
import '../_/nitro.mjs';
import 'lru-cache';
import '@unocss/core';
  ...
  setup(__props) {
    ...
    const emptyTitle = computed(() => {
      if (statusFilter.value === "all" && !filteredQuotes.value.length) {
        return "No sent quotes yet";
      }
      return "No quotes in this status";
    });
    const emptyDescription = computed(() => {
      if (statusFilter.value === "all" && !filteredQuotes.value.length) {
        return "When you send quotes in response to incoming requests, they will appear here.";
      }
...
//# sourceMappingURL=index-T--XbfpK.mjs.map
