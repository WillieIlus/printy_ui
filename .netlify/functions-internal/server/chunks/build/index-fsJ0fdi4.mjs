...
import { e as useRoute, u as useAuthStore, f as useToast, c as _sfc_main$9, a as _sfc_main$f, j as __nuxt_component_5, d as useRuntimeConfig, y as usePublicApi, A as API, h as useApi$1 } from './server.mjs';
import { _ as _sfc_main$5 } from './Badge-BGajth1Y.mjs';
import { a as formatKES } from './formatters-D5StX5za.mjs';
import { _ as _sfc_main$6 } from './Textarea-C5cEpnri.mjs';
...
import { _ as __nuxt_component_9, u as useProductPriceDisplay } from './ProductTweakModal-D-M7HZR4.mjs';
import { u as usePricingStore } from './pricing-DdU3x9mw.mjs';
import { s as stripHtmlToText } from './richText-DycefbI5.mjs';
import { listQuoteRequests } from './quoteDraft-DLjjCgyl.mjs';
...
const __nuxt_component_4 = Object.assign(_sfc_main$4, { __name: "ShopsShopWorkingHours" });
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_ShopsShopWorkingHours = __nuxt_component_4;
      ...
      if (unref(loading)) {
        ...
        _push(`</div><div class="flex items-center gap-3 mt-1 flex-wrap">`);
        ...
        _push(`<p class="text-stone-600 dark:text-stone-400">Click a product to customize and quote</p></div>`);
        ...
        if (unref(catalog)?.shop?.description) {
          _push(`<div class="mt-4 rounded-xl border border-amber-200/60 dark:border-amber-800/40 bg-white/50 dark:bg-stone-900/50 px-4 py-3"><h2 class="text-sm font-semibold text-stone-600 dark:text-stone-400 mb-2">About</h2>`);
          ...
          _push(ssrRenderComponent(_component_UButton, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                ...
                _push2(` View your draft (${ssrInterpolate(unref(quoteDraftStore).activeDraft.items.length)}) `);
              } else {
                return [
                  ...
                  createTextVNode(" View your draft (" + toDisplayString(unref(quoteDraftStore).activeDraft.items.length) + ") ", 1)
                ];
              }
            }),
            _: 1
...
//# sourceMappingURL=index-fsJ0fdi4.mjs.map
