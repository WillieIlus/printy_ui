...
import { f as useRoute, e as useToast, b as _sfc_main$9, a as _sfc_main$f, J as extractApiFeedback, n as navigateTo } from './server.mjs';
...
import { _ as _sfc_main$3 } from './Alert-BQjQ5uNh.mjs';
import { _ as __nuxt_component_4$1 } from './InlineError-CDgd_EMb.mjs';
import { _ as __nuxt_component_4$2 } from './FormSelect-B_nao_f-.mjs';
import { _ as __nuxt_component_5$1 } from './FormTextarea-CvR62LkK.mjs';
import { _ as __nuxt_component_10 } from './LoadingButton-DEusGFiB.mjs';
import { defineComponent, computed, ref, watch, mergeProps, withCtx, createVNode, createTextVNode, unref, toDisplayString, openBlock, createBlock, createCommentVNode, Fragment, useSSRContext } from 'vue';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    function isLaminationCategory(category) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_VeeForm, mergeProps({
        ...
        default: withCtx(({ meta, values }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (isLaminationCategory(values.category)) {
              _push2(`<div class="rounded-xl border border-amber-200 bg-amber-50 p-4 text-sm text-amber-900"${_scopeId}><p class="font-semibold"${_scopeId}>Lamination uses the simplified setup.</p><p class="mt-1"${_scopeId}>Billing: per sheet. Side selection: one side or both sides. Use the main rate per sheet and an optional both-side rate override.</p></div>`);
            } else {
              _push2(`<!--[-->`);
              _push2(ssrRenderComponent(_component_FormsFormSelect, {
                name: "charge_unit",
            ...
            return [
              createVNode("div", { class: "space-y-4" }, [
                ...
                isLaminationCategory(values.category) ? (openBlock(), createBlock("div", {
                  key: 1,
                  class: "rounded-xl border border-amber-200 bg-amber-50 p-4 text-sm text-amber-900"
                }, [
                  createVNode("p", { class: "font-semibold" }, "Lamination uses the simplified setup."),
                  createVNode("p", { class: "mt-1" }, "Billing: per sheet. Side selection: one side or both sides. Use the main rate per sheet and an optional both-side rate override.")
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    function isLamination(item) {
      return item.category === "LAMINATION" || item.billing_basis === "per_sheet" && item.side_mode === "per_selected_side";
    }
    function finishingRuleLabel(item) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(loading)) {
        ...
        ssrRenderList(unref(items), (item) => {
          ...
          _push(`</div><div class="mt-4 rounded-2xl border border-[var(--p-border)] bg-[var(--p-surface-sunken)] p-4"><p class="text-sm text-[var(--p-text-muted)]">Pricing rule</p><p class="mt-1 text-sm font-medium text-[var(--p-text)]">${ssrInterpolate(finishingRuleLabel(item))}</p><p class="mt-3 text-sm text-[var(--p-text-muted)]">Price</p><p class="mt-1 text-lg font-semibold text-[var(--p-text)]">${ssrInterpolate(unref(formatMoney)(item.price))}</p>`);
          if (item.double_side_price && isLamination(item)) {
            _push(`<p class="mt-2 text-sm text-[var(--p-text-muted)]"> Both-side rate: ${ssrInterpolate(unref(formatMoney)(item.double_side_price))}</p>`);
          } else {
            _push(`<!---->`);
          }
...
//# sourceMappingURL=index-nTWFRCGo.mjs.map
