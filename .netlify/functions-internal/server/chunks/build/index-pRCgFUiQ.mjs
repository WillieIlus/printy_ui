...
import { f as useRoute, b as _sfc_main$9, a as _sfc_main$f, _ as __nuxt_component_1 } from './server.mjs';
import { _ as __nuxt_component_3 } from './LoadingSpinner-DC3DKYaG.mjs';
import { _ as __nuxt_component_1$1 } from './SentQuoteStatusBadge-Dq1ROnd-.mjs';
...
import { a as useSentQuotes } from './useIncomingRequests-Dj9ppvKn.mjs';
import '../_/nitro.mjs';
import 'lru-cache';
import '@unocss/core';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_SentQuoteStatusBadge = __nuxt_component_1$1;
      _push(ssrRenderComponent(_component_NuxtLink, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex justify-between items-start gap-3"${_scopeId}><div class="min-w-0 flex-1"${_scopeId}><h3 class="font-semibold text-[var(--p-text)] truncate"${_scopeId}>${ssrInterpolate(__props.quote.customer_name || `Request #${__props.quote.quote_request_id}`)}</h3><p class="mt-0.5 text-sm text-[var(--p-text-muted)]"${_scopeId}>${ssrInterpolate(unref(formatMoney)(__props.quote.total))} `);
            if (__props.quote.turnaround_hours != null) {
              _push2(`<!--[--> | ${ssrInterpolate(__props.quote.turnaround_hours)} working hour${ssrInterpolate(__props.quote.turnaround_hours !== 1 ? "s" : "")}<!--]-->`);
            } else {
              _push2(`<!---->`);
            }
            ...
            _push2(`</div><p class="mt-2 text-xs text-[var(--p-text-muted)]"${_scopeId}>${ssrInterpolate(unref(formatDate)(__props.quote.sent_at || __props.quote.created_at))}</p>`);
          } else {
            return [
              createVNode("div", { class: "flex justify-between items-start gap-3" }, [
                createVNode("div", { class: "min-w-0 flex-1" }, [
                  ...
                  createVNode("p", { class: "mt-0.5 text-sm text-[var(--p-text-muted)]" }, [
                    createTextVNode(toDisplayString(unref(formatMoney)(__props.quote.total)) + " ", 1),
                    __props.quote.turnaround_hours != null ? (openBlock(), createBlock(Fragment, { key: 0 }, [
                      createTextVNode(" | " + toDisplayString(__props.quote.turnaround_hours) + " working hour" + toDisplayString(__props.quote.turnaround_hours !== 1 ? "s" : ""), 1)
              ...
              createVNode("p", { class: "mt-2 text-xs text-[var(--p-text-muted)]" }, toDisplayString(unref(formatDate)(__props.quote.sent_at || __props.quote.created_at)), 1)
            ];
          }
        }),
        _: 1
...
//# sourceMappingURL=index-pRCgFUiQ.mjs.map
