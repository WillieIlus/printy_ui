...
import { F as Form, _ as __nuxt_component_2$1 } from './FormInput-CXwkCB6L.mjs';
import { _ as _sfc_main$2 } from './Alert-BD7KCbft.mjs';
import { _ as _sfc_main$3 } from './Checkbox-Bxr7OL_4.mjs';
...
import { u as useSubmissionFeedback } from './useSubmissionFeedback-BBv01chN.mjs';
import '../_/nitro.mjs';
import 'lru-cache';
import '@unocss/core';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div class="text-center mb-8"><p class="text-xs font-semibold uppercase tracking-[0.16em] text-[var(--p-text-muted)]">Already have an account?</p><h1 class="mt-2 text-2xl font-bold text-[var(--p-text)] sm:text-3xl"> Sign in </h1><p class="mt-2 text-sm text-[var(--p-text-muted)]"> Sign in to continue with your existing Printy account. </p></div><div class="rounded-2xl border border-[var(--p-border)] bg-[var(--p-surface)] shadow-sm p-6 sm:p-8">`);
      _push(ssrRenderComponent(_component_AuthLoginForm, null, null, _parent));
      _push(`</div><p class="mt-6 text-center text-sm text-[var(--p-text-muted)]"> Need a new account? `);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/auth/signup",
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`Create one here`);
          } else {
            return [
              createTextVNode("Create one here")
            ];
          }
        }),
        _: 1
      }, _parent));
      _push(`</p></div></div><aside class="hidden lg:flex lg:w-1/2 lg:min-w-0 shrink-0 flex-col justify-center bg-[var(--p-surface-sunken)] text-[var(--p-text)] p-8 xl:p-12"><h2 class="text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl mb-8"> Sign in to continue </h2><p class="text-lg text-[var(--p-text-muted)] mb-10 leading-relaxed"> Existing accounts land in the right workspace after login. New role and shop-start choices now happen during account creation. </p><ul class="space-y-6"><li class="flex gap-4"><div class="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-[var(--p-text)]/10 text-[var(--p-text)]">`);
      _push(ssrRenderComponent(_component_UIcon, {
        name: "i-lucide-calculator",
        class: "w-6 h-6"
      }, null, _parent));
      _push(`</div><div><p class="text-lg font-bold">Preview pricing quickly</p><p class="text-base text-[var(--p-text-muted)] mt-0.5">Open the calculator, check totals, and move forward without guesswork.</p></div></li><li class="flex gap-4"><div class="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-[var(--p-text)]/10 text-[var(--p-text)]">`);
      _push(ssrRenderComponent(_component_UIcon, {
        name: "i-lucide-receipt",
        class: "w-6 h-6"
      }, null, _parent));
      _push(`</div><div><p class="text-lg font-bold">Land in the right place</p><p class="text-base text-[var(--p-text-muted)] mt-0.5">Clients go to drafts, staff go to their workspace, and shop owners keep their dashboard flow.</p></div></li><li class="flex gap-4"><div class="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-[var(--p-text)]/10 text-[var(--p-text)]">`);
      _push(ssrRenderComponent(_component_UIcon, {
        name: "i-lucide-clipboard-list",
        class: "w-6 h-6"
      }, null, _parent));
      _push(`</div><div><p class="text-lg font-bold">Handle quotes clearly</p><p class="text-base text-[var(--p-text-muted)] mt-0.5">Track pending, modified, accepted, and rejected work from one sign-in.</p></div></li><li class="flex gap-4"><div class="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-[var(--p-text)]/10 text-[var(--p-text)]">`);
      _push(ssrRenderComponent(_component_UIcon, {
        name: "i-lucide-store",
        class: "w-6 h-6"
      }, null, _parent));
      _push(`</div><div><p class="text-lg font-bold">Keep shop setup intact</p><p class="text-base text-[var(--p-text-muted)] mt-0.5">Shop owners without a shop still continue through the correct setup path after sign-in.</p></div></li></ul></aside></div></div>`);
    };
  }
});
...
//# sourceMappingURL=login-BBV8ZsMo.mjs.map
