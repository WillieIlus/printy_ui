...
import { f as useRoute, d as _sfc_main$9, r as _sfc_main$c } from './server.mjs';
import { _ as __nuxt_component_4 } from './SkeletonState-BhcHA7h3.mjs';
import { _ as _sfc_main$2 } from './Card-CXU7vIvE.mjs';
import { _ as _sfc_main$3 } from './Badge-C1UUP90f.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_UCard, _attrs, {
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h3 class="text-lg font-semibold text-[var(--p-text)]"${_scopeId}>Team members</h3>`);
          } else {
            return [
              createVNode("h3", { class: "text-lg font-semibold text-[var(--p-text)]" }, "Team members")
            ];
          }
        }),
          ...
          if (_push2) {
            if (__props.members?.length) {
              ...
              ssrRenderList(__props.members, (m) => {
                _push2(`<div class="flex items-center justify-between rounded-lg border border-[var(--p-border)] bg-[var(--p-surface-container-low)] p-3"${_scopeId}><div class="flex items-center gap-3"${_scopeId}>`);
                _push2(ssrRenderComponent(_component_UAvatar, { size: "sm" }, null, _parent2, _scopeId));
                _push2(`<div${_scopeId}><p class="font-medium text-[var(--p-text)]"${_scopeId}>${ssrInterpolate(m.user_details?.first_name ?? `User #${m.user}`)}</p>`);
              ...
              _push2(`<p class="text-sm text-[var(--p-text-muted)]"${_scopeId}>No members yet.</p>`);
            }
          } else {
            return [
                  ...
                  return openBlock(), createBlock("div", {
                    ...
                    createVNode("div", { class: "flex items-center gap-3" }, [
                      ...
                      createVNode("div", null, [
                        createVNode("p", { class: "font-medium text-[var(--p-text)]" }, toDisplayString(m.user_details?.first_name ?? `User #${m.user}`), 1),
...
//# sourceMappingURL=members-Ch0UjIC7.mjs.map
