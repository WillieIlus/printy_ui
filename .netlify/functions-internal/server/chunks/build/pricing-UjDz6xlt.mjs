...
import { m as useNuxtApp, A as API, p as parseApiError } from './server.mjs';
...
const usePricingStore = defineStore("pricing", {
  ...
  actions: {
    ...
    async updatePrintingPrice(_slug, pk, data) {
      ...
      if (data.duplex_surcharge_enabled !== void 0) payload.duplex_surcharge_enabled = data.duplex_surcharge_enabled;
      if (data.duplex_surcharge_min_gsm !== void 0) payload.duplex_surcharge_min_gsm = data.duplex_surcharge_min_gsm ?? null;
...
//# sourceMappingURL=pricing-UjDz6xlt.mjs.map
