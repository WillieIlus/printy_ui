import { a as _sfc_main$f, b as _sfc_main$9, _ as __nuxt_component_1, n as navigateTo, x as useLocale, i as useAppConfig, y as usePortal, t as tv } from './server.mjs';
import { defineComponent, ref, watch, nextTick, mergeProps, withCtx, createVNode, createTextVNode, isRef, unref, openBlock, createBlock, createCommentVNode, toDisplayString, renderSlot, useSlots, toRef, computed, toHandlers, Fragment, useSSRContext } from 'vue';
...
import { _ as __nuxt_component_3$1 } from './ShopForm-CbgPlMMT.mjs';
...
import './InfoCard-D-56bxET.mjs';
import './Alert-BQjQ5uNh.mjs';
import './FormSection-CG38mMf8.mjs';
import './Input-Hudv-7BP.mjs';
import './FieldHint-i6LQE4WY.mjs';
import './InlineError-CDgd_EMb.mjs';
import './Textarea-DUPwu95P.mjs';
import './LoadingButton-DEusGFiB.mjs';
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_UModal, mergeProps({
        ...
        title: __props.title,
        description: __props.description || "Form dialog",
        ui: __props.ui,
        scrollable: "",
        "onUpdate:open": ($event) => _ctx.$emit("update:modelValue", $event)
      }, _attrs), {
        content: withCtx(({ close }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex max-h-[85vh] min-h-0 flex-col overflow-hidden rounded-lg border border-[var(--p-border)] bg-[var(--p-surface-raised)] shadow-lg"${_scopeId}><div class="shrink-0 border-b border-[var(--p-border)] px-4 py-4 sm:px-6"${_scopeId}><h2 id="dashboard-modal-title" class="text-base font-semibold text-[var(--p-text)] sm:text-lg"${_scopeId}>${ssrInterpolate(__props.title)}</h2>`);
            if (__props.description) {
              _push2(`<p id="dashboard-modal-description" class="mt-0.5 text-sm text-[var(--p-text-muted)]"${_scopeId}>${ssrInterpolate(__props.description)}</p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div class="flex-1 min-h-0 overflow-y-auto p-4 sm:p-5 [&amp;_input]:w-full [&amp;_select]:w-full [&amp;_textarea]:w-full"${_scopeId}>`);
            ssrRenderSlot(_ctx.$slots, "default", { close }, null, _push2, _parent2, _scopeId);
            _push2(`</div>`);
            if (_ctx.$slots.footer) {
              _push2(`<div class="shrink-0 border-t border-[var(--p-border)] bg-[var(--p-surface)] px-4 py-4 sm:px-6"${_scopeId}>`);
              ssrRenderSlot(_ctx.$slots, "footer", { close }, null, _push2, _parent2, _scopeId);
              _push2(`</div>`);
            } else {
              _push2(`<!---->`);
            }
            ...
            return [
              createVNode("div", { class: "flex max-h-[85vh] min-h-0 flex-col overflow-hidden rounded-lg border border-[var(--p-border)] bg-[var(--p-surface-raised)] shadow-lg" }, [
                createVNode("div", { class: "shrink-0 border-b border-[var(--p-border)] px-4 py-4 sm:px-6" }, [
                  createVNode("h2", {
                    id: "dashboard-modal-title",
                    class: "text-base font-semibold text-[var(--p-text)] sm:text-lg"
                ...
                createVNode("div", { class: "flex-1 min-h-0 overflow-y-auto p-4 sm:p-5 [&_input]:w-full [&_select]:w-full [&_textarea]:w-full" }, [
                  renderSlot(_ctx.$slots, "default", { close })
                ]),
                _ctx.$slots.footer ? (openBlock(), createBlock("div", {
                  key: 0,
                  class: "shrink-0 border-t border-[var(--p-border)] bg-[var(--p-surface)] px-4 py-4 sm:px-6"
                }, [
                  renderSlot(_ctx.$slots, "footer", { close })
                ])) : createCommentVNode("", true)
              ])
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/dashboard/DashboardModalForm.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const __nuxt_component_3 = Object.assign(_sfc_main$1, { __name: "DashboardModalForm" });
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_DashboardModalForm = __nuxt_component_3;
          ...
          if (_push2) {
            ...
            return [
              unref(formReady) ? (openBlock(), createBlock(_component_ShopsShopForm, {
                ...
                onSubmit,
                onCancel: closeModal
              }, null, 8, ["loading", "error", "field-errors"])) : createCommentVNode("", true)
            ];
          }
        }),
        _: 1
...
//# sourceMappingURL=printer-B8H84Iup.mjs.map
