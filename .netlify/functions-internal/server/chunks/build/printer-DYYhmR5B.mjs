import { a as _sfc_main$f, d as _sfc_main$9, _ as __nuxt_component_3$1, n as navigateTo, o as useLocale, p as useAppConfig, I as usePortal, t as tv } from './server.mjs';
...
import { _ as __nuxt_component_3$2 } from './ShopForm-Cc9JKo7G.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_UModal, mergeProps({
        ...
        content: withCtx(({ close }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex max-h-[85vh] min-h-0 flex-col overflow-hidden rounded-xl bg-[var(--p-surface)] shadow-xl border border-[var(--p-border)]"${_scopeId}><div class="shrink-0 border-b border-[var(--p-border)] px-4 sm:px-6 py-4"${_scopeId}><h2 id="dashboard-modal-title" class="text-lg font-semibold text-[var(--p-text)]"${_scopeId}>${ssrInterpolate(__props.title)}</h2>`);
            ...
            _push2(`</div><div class="flex-1 min-h-0 overflow-y-auto p-4 sm:p-6 [&amp;_input]:w-full [&amp;_select]:w-full [&amp;_textarea]:w-full"${_scopeId}>`);
            ssrRenderSlot(_ctx.$slots, "default", { close }, null, _push2, _parent2, _scopeId);
            _push2(`</div>`);
            if (_ctx.$slots.footer) {
              _push2(`<div class="shrink-0 border-t border-[var(--p-border)] bg-[var(--p-surface)] px-4 sm:px-6 py-4"${_scopeId}>`);
            ...
            return [
              createVNode("div", { class: "flex max-h-[85vh] min-h-0 flex-col overflow-hidden rounded-xl bg-[var(--p-surface)] shadow-xl border border-[var(--p-border)]" }, [
                createVNode("div", { class: "shrink-0 border-b border-[var(--p-border)] px-4 sm:px-6 py-4" }, [
                  createVNode("h2", {
                    id: "dashboard-modal-title",
                    class: "text-lg font-semibold text-[var(--p-text)]"
                ...
                createVNode("div", { class: "flex-1 min-h-0 overflow-y-auto p-4 sm:p-6 [&_input]:w-full [&_select]:w-full [&_textarea]:w-full" }, [
                  renderSlot(_ctx.$slots, "default", { close })
                ]),
                _ctx.$slots.footer ? (openBlock(), createBlock("div", {
                  key: 0,
                  class: "shrink-0 border-t border-[var(--p-border)] bg-[var(--p-surface)] px-4 sm:px-6 py-4"
                }, [
                  renderSlot(_ctx.$slots, "footer", { close })
                ])) : createCommentVNode("", true)
              ])
...
//# sourceMappingURL=printer-DYYhmR5B.mjs.map
