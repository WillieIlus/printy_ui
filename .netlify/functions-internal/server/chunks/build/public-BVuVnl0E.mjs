import { A as API, r as usePublicApi, q as usePublicApiNoAuth } from './server.mjs';
...
async function getShopCustomOptions(shopSlug, publicApi = usePublicApiNoAuth()) {
  return await publicApi(API.publicShopCustomOptions(shopSlug));
}

export { getShopCustomOptions as a, getCatalog as g, listShops as l, matchShops as m, previewShopCalculator as p };
//# sourceMappingURL=public-BVuVnl0E.mjs.map
