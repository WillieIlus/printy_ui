...
const _routes = [
  {
    ...
    component: () => import('./help-B2YyqFdj.mjs')
  },
  {
    name: "about",
    path: "/about",
    meta: __nuxt_page_meta$Z || {},
    component: () => import('./about-DzTeSD6-.mjs')
  },
  {
    name: "index",
    path: "/",
    meta: __nuxt_page_meta$Y || {},
    component: () => import('./index-CZ3nKSG_.mjs')
  },
  {
    name: "terms",
    path: "/terms",
    meta: __nuxt_page_meta$X || {},
    component: () => import('./terms-DJAJs61O.mjs')
  },
  {
    name: "privacy",
    path: "/privacy",
    meta: __nuxt_page_meta$W || {},
    component: () => import('./privacy-BTLbBK98.mjs')
  },
  {
    name: "auth-login",
    path: "/auth/login",
    meta: { ...__nuxt_page_meta$V || {}, ...{ "middleware": "guest" } },
    component: () => import('./login-CwPGKxU2.mjs')
  },
  {
    name: "auth-signup",
    path: "/auth/signup",
    meta: { ...__nuxt_page_meta$U || {}, ...{ "middleware": "guest" } },
    component: () => import('./signup-DzG6iOn9.mjs')
  },
  {
    name: "quote-draft",
    path: "/quote-draft",
    meta: __nuxt_page_meta$T || {},
    component: () => import('./quote-draft-CUarepBa.mjs')
  },
  {
    name: "quote-print",
    path: "/quote/print",
    meta: __nuxt_page_meta$S || {},
    component: () => import('./print-BxG3HdfB.mjs')
  },
  {
    name: "quotes-id",
    path: "/quotes/:id()",
    meta: __nuxt_page_meta$R || {},
    component: () => import('./_id_-D3ADooAi.mjs')
  },
  {
    name: "shops",
    path: "/shops",
    meta: __nuxt_page_meta$Q || {},
    component: () => import('./index-DR158tMK.mjs')
  },
  {
    name: "me-favorites",
    path: "/me/favorites",
    meta: { ...__nuxt_page_meta$P || {}, ...{ "middleware": "auth" } },
    component: () => import('./favorites-BKi6HK2L.mjs')
  },
  {
    name: "quotes",
    path: "/quotes",
    meta: __nuxt_page_meta$O || {},
    component: () => import('./index-EYgRWm3t.mjs')
  },
  {
    name: "shops-nearby",
    path: "/shops/nearby",
    meta: __nuxt_page_meta$N || {},
    component: () => import('./nearby-BrUKFNsQ.mjs')
  },
  {
    name: "gallery",
    path: "/gallery",
    meta: __nuxt_page_meta$M || {},
    component: () => import('./index-Qxrx3ZQ1.mjs')
  },
  {
    name: "products",
    path: "/products",
    meta: __nuxt_page_meta$L || {},
    component: () => import('./index-B-rX2LF_.mjs')
  },
  {
    name: "dashboard",
    path: "/dashboard",
    meta: { ...__nuxt_page_meta$K || {}, ...{ "middleware": ["auth", "setup-guard"] } },
    component: () => import('./index-CtEtp93N.mjs')
  },
  {
    name: "locations",
    path: "/locations",
    meta: __nuxt_page_meta$J || {},
    component: () => import('./index-CxNMZN63.mjs')
  },
  {
    name: "products-slug",
    path: "/products/:slug()",
    meta: __nuxt_page_meta$I || {},
    component: () => import('./_slug_-CkCSpJTR.mjs')
  },
  {
    name: "dashboard-papers",
    path: "/dashboard/papers",
    meta: { ...__nuxt_page_meta$H || {}, ...{ "middleware": ["auth"] } },
    component: () => import('./papers-Dpo5ZLSu.mjs')
  },
  {
    name: "locations-slug",
    path: "/locations/:slug()",
    meta: __nuxt_page_meta$G || {},
    component: () => import('./_slug_-BDpoSYY3.mjs')
  },
  {
    name: "products-gallery",
    path: "/products/gallery",
    meta: __nuxt_page_meta$F || {},
    component: () => import('./gallery-CEGcPxbp.mjs')
  },
  {
    name: "auth-verify-email",
    path: "/auth/verify-email",
    meta: { ...__nuxt_page_meta$E || {}, ...{ "middleware": "guest" } },
    component: () => import('./verify-email-BLNucEbk.mjs')
  },
  {
    name: "dashboard-pricing",
    path: "/dashboard/pricing",
    meta: { ...__nuxt_page_meta$D || {}, ...{ "middleware": ["auth"] } },
    component: () => import('./pricing-COyXbmu_.mjs')
  },
  {
    name: "dashboard-machines",
    path: "/dashboard/machines",
    meta: { ...__nuxt_page_meta$B || {}, ...{ "middleware": ["auth"] } },
    component: () => import('./machines-DNEgjvvf.mjs'),
    children: [
      {
        name: "dashboard-machines-id-rates",
        path: ":id()/rates",
        meta: { ...__nuxt_page_meta$C || {}, ...{ "middleware": "auth" } },
        component: () => import('./rates-BQBF7jr2.mjs')
      }
    ]
  },
  {
  ...
  },
  {
    ...
    component: () => import('./_id_-BvbZdZhA.mjs')
  },
  {
...
const namedMiddleware = {
  auth: () => import('./auth-0L0rRH-F.mjs'),
  guest: () => import('./guest-szRZnh3T.mjs'),
  "setup-guard": () => import('./setup-guard-DjLodQaB.mjs'),
  "shop-owner": () => import('./shop-owner-B5BCPRuQ.mjs')
};
...
const API = {
  ...
  quoteDraftsActive: (shopSlug) => `quote-drafts/active/?shop=${encodeURIComponent(shopSlug)}`,
  ...
  quoteRequestSubmit: (draftId) => `quote-requests/${draftId}/submit/`,
  // Shops
  shops: () => "shops/",
  ...
  myQuotes: () => "my-quotes/",
  // Favorites (buyer)
  shopFavorite: (shopId) => `shops/${shopId}/favorite/`,
  ...
  shopPaper: (slug) => `shops/${slug}/paper/`,
  shopPaperDetail: (slug, pk) => `shops/${slug}/paper/${pk}/`,
  shopPaperAdjust: (slug, pk) => `shops/${slug}/paper/${pk}/adjust/`,
  shopFinishingServices: (slug) => `shops/${slug}/pricing/finishing/`,
  shopFinishingServiceDetail: (slug, pk) => `shops/${slug}/pricing/finishing/${pk}/`,
  shopMaterialPrices: (slug) => `shops/${slug}/pricing/material-prices/`,
  shopMaterialPriceDetail: (slug, pk) => `shops/${slug}/pricing/material-prices/${pk}/`,
...
const layouts = {
  admin: defineAsyncComponent(() => import('./admin-B25FqO_H.mjs').then((m) => m.default || m)),
  auth: defineAsyncComponent(() => import('./auth-D2GA0pCP.mjs').then((m) => m.default || m)),
  blank: defineAsyncComponent(() => import('./blank-D7UwsMKw.mjs').then((m) => m.default || m)),
  dashboard: defineAsyncComponent(() => import('./dashboard-DBrH7wfu.mjs').then((m) => m.default || m)),
  default: defineAsyncComponent(() => import('./default-CJ_cvkPV.mjs').then((m) => m.default || m))
};
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import('./island-renderer-C6nnr3mV.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
    nuxtApp.deferHydration();
...
const server = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  A: API,
  B: formErrorsInjectionKey,
  C: formInputsInjectionKey,
  D: inputIdInjectionKey,
  E: formFieldInjectionKey,
  F: usePortal,
  G: get,
  H: isArrayOfArray,
  I: compare,
  ...
  K: getDisplayValue,
  L: _export_sfc,
  M: defineNuxtRouteMiddleware,
  N: useState,
  O: __nuxt_component_0$2,
  P: useOgImageRuntimeConfig,
  Q: useSiteConfig,
  _: __nuxt_component_2,
  a: _sfc_main$f,
  b: __nuxt_component_3$1,
  c: createError,
  d: _sfc_main$9,
...
export { trimLength as $, API as A, inputIdInjectionKey as B, formFieldInjectionKey as C, usePortal as D, isArrayOfArray as E, get as F, compare as G, _sfc_main$d as H, getDisplayValue as I, _export_sfc as J, defineNuxtRouteMiddleware as K, useState as L, injectHead as M, createError as N, defineSchemaOrgResolver as O, resolveRelation as P, setIfEmpty as Q, asArray as R, resolveWithBase as S, resolvableDateToIso as T, idReference as U, resolveAsGraphKey as V, IdentityId as W, prefixId as X, imageResolver as Y, resolveDefaultType as Z, __nuxt_component_2 as _, _sfc_main$f as a, resolvableDateToDate as a0, resolveNode as a1, dedupeMerge as a2, __nuxt_component_0$2 as a3, useOgImageRuntimeConfig as a4, useSiteConfig as a5, server as a6, __nuxt_component_3$1 as b, _sfc_main$9 as c, __nuxt_component_0 as d, useAuthStore as e, useRoute as f, useToast as g, _sfc_main$c as h, __nuxt_component_5 as i, useAppConfig as j, useFieldGroup as k, useComponentIcons as l, useHead as m, navigateTo as n, useRuntimeConfig as o, useLocale as p, useFormField as q, useRouter as r, useNuxtApp as s, tv as t, usePublicApi as u, safeLogError as v, useApi as w, looseToNumber as x, formErrorsInjectionKey as y, formInputsInjectionKey as z };
