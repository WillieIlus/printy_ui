import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { isRef, inject, provide, computed, toValue, useModel, unref, mergeProps, withCtx, renderSlot, createVNode, openBlock, createBlock, createTextVNode, toDisplayString, createCommentVNode, mergeModels, defineComponent, createElementBlock, h, resolveDynamicComponent, shallowRef, getCurrentInstance, cloneVNode, ref, useSlots, hasInjectionContext, watch, onServerPrefetch, toRef, resolveComponent, useAttrs, useTemplateRef, defineAsyncComponent, nextTick, useSSRContext, Suspense, shallowReactive, Fragment, createApp, renderList, useId, onErrorCaptured, reactive, effectScope, withModifiers, getCurrentScope, markRaw, isReadonly, toRaw, isShallow, isReactive } from 'vue';
...
const _routes = [
  {
    ...
    component: () => import('./help-D7APwGxj.mjs')
  },
  {
    name: "about",
    path: "/about",
    meta: __nuxt_page_meta$1b || {},
    component: () => import('./about-QSTEd8p4.mjs')
  },
  {
    name: "index",
    path: "/",
    meta: __nuxt_page_meta$1a || {},
    component: () => import('./index-l0NEqzFi.mjs')
  },
  {
    name: "terms",
    path: "/terms",
    meta: __nuxt_page_meta$19 || {},
    component: () => import('./terms-rAePH0Be.mjs')
  },
  {
    name: "privacy",
    path: "/privacy",
    meta: __nuxt_page_meta$18 || {},
    component: () => import('./privacy-DZJn8rgZ.mjs')
  },
  {
    name: "auth-login",
    path: "/auth/login",
    meta: { ...__nuxt_page_meta$17 || {}, ...{ "middleware": "guest" } },
    component: () => import('./login-m-G4ICYy.mjs')
  },
  {
    name: "admin",
    path: "/admin",
    meta: { ...__nuxt_page_meta$16 || {}, ...{ "middleware": ["auth", "super-admin"] } },
    component: () => import('./index-BnuwjAlt.mjs')
  },
  {
    name: "auth-signup",
    path: "/auth/signup",
    meta: { ...__nuxt_page_meta$15 || {}, ...{ "middleware": "guest" } },
    component: () => import('./signup-DjB6M3ma.mjs')
  },
  {
    name: "quote-draft",
    path: "/quote-draft",
    meta: __nuxt_page_meta$14 || {},
    component: () => import('./quote-draft-DjqIVgJq.mjs')
  },
  {
    name: "quote-print",
    path: "/quote/print",
    meta: __nuxt_page_meta$13 || {},
    component: () => import('./print-D-v68SWV.mjs')
  },
  {
    name: "quotes-id",
    path: "/quotes/:id()",
    meta: { ...__nuxt_page_meta$12 || {}, ...{ "middleware": "auth" } },
    component: () => import('./_id_-D-ZYyh-h.mjs')
  },
  {
    name: "shops",
    path: "/shops",
    meta: __nuxt_page_meta$11 || {},
    component: () => import('./index-Cs_b9Bf8.mjs')
  },
  {
    name: "admin-errors",
    path: "/admin/errors",
    meta: { ...__nuxt_page_meta$10 || {}, ...{ "middleware": ["auth", "super-admin"] } },
    component: () => import('./errors-Ck2sh_MM.mjs')
  },
  {
    name: "me-favorites",
    path: "/me/favorites",
    meta: { ...__nuxt_page_meta$$ || {}, ...{ "middleware": "auth" } },
    component: () => import('./favorites-DGZpDJHs.mjs')
  },
  {
    name: "quotes",
    path: "/quotes",
    meta: { ...__nuxt_page_meta$_ || {}, ...{ "middleware": "auth" } },
    component: () => import('./index-CD1QGphb.mjs')
  },
  {
    name: "shops-nearby",
    path: "/shops/nearby",
    meta: __nuxt_page_meta$Z || {},
    component: () => import('./nearby-Dw_asm5w.mjs')
  },
  {
    name: "gallery",
    path: "/gallery",
    meta: __nuxt_page_meta$Y || {},
    component: () => import('./index-OPPmuHcN.mjs')
  },
  {
    name: "quotes-create",
    path: "/quotes/create",
    meta: { ...__nuxt_page_meta$X || {}, ...{ "middleware": "auth" } },
    component: () => import('./create-DxOUSAkP.mjs')
  },
  {
    name: "products",
    path: "/products",
    meta: __nuxt_page_meta$W || {},
    component: () => import('./index-BnUrtIz4.mjs')
  },
  {
    name: "admin-locations",
    path: "/admin/locations",
    meta: { ...__nuxt_page_meta$V || {}, ...{ "middleware": ["auth", "super-admin"] } },
    component: () => import('./locations-BSfsYc5I.mjs')
  },
  {
    name: "dashboard",
    path: "/dashboard",
    meta: { ...__nuxt_page_meta$U || {}, ...{ "middleware": ["auth", "setup-guard"] } },
    component: () => import('./index--j25SM1O.mjs')
  },
  {
    name: "locations",
    path: "/locations",
    meta: __nuxt_page_meta$T || {},
    component: () => import('./index-C7etB3Py.mjs')
  },
  {
    name: "products-slug",
    path: "/products/:slug()",
    meta: __nuxt_page_meta$S || {},
    component: () => import('./_slug_-BXmnl5dO.mjs')
  },
  {
    name: "dashboard-papers",
    path: "/dashboard/papers",
    meta: { ...__nuxt_page_meta$R || {}, ...{ "middleware": ["auth"] } },
    component: () => import('./papers-KnVmVA_4.mjs')
  },
  {
    name: "locations-slug",
    path: "/locations/:slug()",
    meta: __nuxt_page_meta$Q || {},
    component: () => import('./_slug_-YordraRK.mjs')
  },
  {
    name: "products-gallery",
    path: "/products/gallery",
    meta: __nuxt_page_meta$P || {},
    component: () => import('./gallery-Ivuz28Rp.mjs')
  },
  {
    name: "auth-verify-email",
    path: "/auth/verify-email",
    meta: { ...__nuxt_page_meta$O || {}, ...{ "middleware": "guest" } },
    component: () => import('./verify-email-gwDsk9GJ.mjs')
  },
  {
    name: "dashboard-pricing",
    path: "/dashboard/pricing",
    meta: { ...__nuxt_page_meta$N || {}, ...{ "middleware": ["auth"] } },
    component: () => import('./pricing-9Qm_coH-.mjs')
  },
  {
    name: "dashboard-machines",
    path: "/dashboard/machines",
    meta: { ...__nuxt_page_meta$L || {}, ...{ "middleware": ["auth"] } },
    component: () => import('./machines-C4QMPwDb.mjs'),
    children: [
      {
        name: "dashboard-machines-id-rates",
        path: ":id()/rates",
        meta: { ...__nuxt_page_meta$M || {}, ...{ "middleware": "auth" } },
        component: () => import('./rates-I7W43WWQ.mjs')
      }
    ]
  },
  {
  ...
  },
  {
    ...
    component: () => import('./_id_-BkNFQNMt.mjs')
  },
  {
  ...
  },
  {
    ...
    component: () => import('./create-Cd9RZfz5.mjs')
  },
  {
  ...
  },
  {
    ...
    component: () => import('./index-ekWxQPzG.mjs')
  },
  {
    ...
    component: () => import('./_id_-BjJz4ct_.mjs')
  },
  {
    ...
    component: () => import('./index-phuVGXgO.mjs')
  }
];
...
const namedMiddleware = {
  auth: () => import('./auth-CUOYn6qn.mjs'),
  guest: () => import('./guest-Dtydrktv.mjs'),
  "setup-guard": () => import('./setup-guard-CDj_eZWp.mjs'),
  "shop-owner": () => import('./shop-owner-BBs2g_vB.mjs'),
  "super-admin": () => import('./super-admin-CZWrrspS.mjs')
};
...
const layouts = {
  admin: defineAsyncComponent(() => import('./admin-C12-FimE.mjs').then((m) => m.default || m)),
  auth: defineAsyncComponent(() => import('./auth-BiCshPIa.mjs').then((m) => m.default || m)),
  blank: defineAsyncComponent(() => import('./blank-D7UwsMKw.mjs').then((m) => m.default || m)),
  dashboard: defineAsyncComponent(() => import('./dashboard-BG78F6SN.mjs').then((m) => m.default || m)),
  default: defineAsyncComponent(() => import('./default-ogQeLaK5.mjs').then((m) => m.default || m))
};
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import('./island-renderer-DPIc6OJb.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
    nuxtApp.deferHydration();
...
const server = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  ...
  A: API,
  B: useFormField,
  C: extractApiFeedback,
  D: safeLogError,
  E: useComponentIcons,
  F: looseToNumber,
  G: formErrorsInjectionKey,
  H: formInputsInjectionKey,
  I: inputIdInjectionKey,
  J: formFieldInjectionKey,
  K: useFieldGroup,
  L: usePortal,
  M: get,
  N: isArrayOfArray,
  ...
  f: useRuntimeConfig,
  g: usePublicApi,
  h: usePublicApiNoAuth,
  i: injectHead,
  j: useToast,
  k: useAnalyticsTracking,
  l: useRoute,
  m: useApi,
  n: navigateTo,
  o: _sfc_main$c,
  p: __nuxt_component_5,
  q: useNuxtApp,
  r: parseApiError,
  s: useRouter,
  t: __nuxt_component_0,
  u: useAsyncData,
  v: useHead,
  w: useState,
  x: useLocale,
...
export { idReference as $, API as A, looseToNumber as B, formErrorsInjectionKey as C, formInputsInjectionKey as D, inputIdInjectionKey as E, formFieldInjectionKey as F, useFieldGroup as G, __nuxt_component_5 as H, usePortal as I, __nuxt_component_0 as J, isArrayOfArray as K, get as L, compare as M, _sfc_main$d as N, getDisplayValue as O, __nuxt_component_2$1 as P, _export_sfc as Q, defineNuxtRouteMiddleware as R, injectHead as S, createError as T, defineSchemaOrgResolver as U, resolveRelation as V, setIfEmpty as W, asArray as X, resolveWithBase as Y, resolvableDateToIso as Z, __nuxt_component_3$1 as _, _sfc_main$f as a, resolveAsGraphKey as a0, IdentityId as a1, prefixId as a2, imageResolver as a3, resolveDefaultType as a4, trimLength as a5, resolvableDateToDate as a6, resolveNode as a7, dedupeMerge as a8, __nuxt_component_0$2 as a9, useOgImageRuntimeConfig as aa, useSiteConfig as ab, server as ac, __nuxt_component_2 as b, useAuthStore as c, _sfc_main$9 as d, useRuntimeConfig as e, usePublicApi as f, useRoute as g, useAnalyticsTracking as h, useToast as i, usePublicApiNoAuth as j, useApi as k, useHead as l, useState as m, navigateTo as n, useLocale as o, useAppConfig as p, _sfc_main$c as q, useFormField as r, useRouter as s, tv as t, useAsyncData as u, extractApiFeedback as v, parseApiError as w, useNuxtApp as x, safeLogError as y, useComponentIcons as z };
