import { f as useRoute, c as _sfc_main$9, a as _sfc_main$f, g as useToast, w as useApi, A as API, v as safeLogError } from './server.mjs';
import { _ as __nuxt_component_2$1 } from './LoadingSpinner-DUXHKoma.mjs';
import { _ as _sfc_main$6 } from './Badge-CGrQBVmm.mjs';
import { _ as __nuxt_component_5$1 } from './DashboardModalForm-BowtHhI0.mjs';
import { _ as _sfc_main$7 } from './FormField-CCAAD2YO.mjs';
import { _ as _sfc_main$8 } from './Input-il5BObb7.mjs';
import { _ as _sfc_main$a } from './SelectMenu-Cud-scqw.mjs';
import { _ as _sfc_main$b } from './Checkbox-BX22gW7J.mjs';
...
import { b as listMachinesBySlug, h as deleteMachineBySlug, i as updateMachineBySlug, j as createMachineBySlug, a as listPapersBySlug, k as deletePaperBySlug, m as updatePaperBySlug, n as createPaperBySlug, o as listFinishingRatesBySlug, p as deleteFinishingRateBySlug, q as updateFinishingRateBySlug, r as createFinishingRateBySlug, f as listMaterialsBySlug, s as deleteMaterialBySlug, t as updateMaterialBySlug, v as createMaterialBySlug, w as listProductsBySlug, x as listProductCategoriesBySlug, y as deleteProductBySlug, z as createProductCategoryBySlug, A as updateProductBySlug, B as createProductBySlug } from './seller-laoC9_qJ.mjs';
import { _ as _sfc_main$c } from './Alert-Dt8CKxt0.mjs';
import { _ as _sfc_main$d } from './Textarea-GjRObXeo.mjs';
import { u as useApi$1 } from './useApi-DI30RcgD.mjs';
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (unref(hasDraft) && !unref(editing)) {
              _push2(`<p class="text-xs text-[var(--p-text-muted)] italic"${_scopeId}>Draft saved automatically</p>`);
            } else {
              _push2(`<!---->`);
            }
            ...
            return [
              createVNode("form", {
                ...
                unref(hasDraft) && !unref(editing) ? (openBlock(), createBlock("p", {
                  key: 0,
                  class: "text-xs text-[var(--p-text-muted)] italic"
                }, "Draft saved automatically")) : createCommentVNode("", true),
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UIcon = _sfc_main$f;
      const _component_CommonLoadingSpinner = __nuxt_component_2$1;
      const _component_UAlert = _sfc_main$c;
      const _component_UBadge = _sfc_main$6;
      const _component_DashboardModalForm = __nuxt_component_5$1;
      const _component_UFormField = _sfc_main$7;
      const _component_UInput = _sfc_main$8;
      ...
      if (unref(loading) && !unref(items).length) {
        ...
        ssrRenderList(unref(items), (p) => {
          ...
          _push(`</td><td class="px-4 py-3 text-sm text-[var(--p-text-muted)]">${ssrInterpolate(p.pricing_mode)}</td><td class="px-4 py-3 text-sm text-[var(--p-text-muted)]">${ssrInterpolate(p.default_finished_width_mm)} × ${ssrInterpolate(p.default_finished_height_mm)}</td><td class="px-4 py-3 text-center text-sm text-[var(--p-text-muted)]">${ssrInterpolate(p.min_quantity ?? 1)}</td><td class="px-4 py-3 text-center text-sm text-[var(--p-text-muted)]">${ssrInterpolate(p.finishing_options?.length ?? 0)}</td><td class="px-4 py-3 text-center">`);
          _push(ssrRenderComponent(_component_UBadge, {
            color: p.is_active ? "success" : "neutral",
            variant: "soft",
            size: "xs"
...
//# sourceMappingURL=setup-5ZH0Ivxe.mjs.map
