...
import { u as useAdminWorkspace, a as useSetupChecklist } from './useAdminWorkspace-f_blWgUx.mjs';
...
import './useSetupStatus-DBIzE8qw.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div class="mt-5"><div class="h-2 overflow-hidden rounded-full bg-[var(--p-surface-sunken)]"><div class="h-full rounded-full bg-orange-500 transition-all" style="${ssrRenderStyle({ width: `${unref(progressPercent)}%` })}"></div></div></div><div class="mt-6 grid gap-4 md:grid-cols-2 xl:grid-cols-5"><!--[-->`);
...
//# sourceMappingURL=setup-guide-IgI6eRiS.mjs.map
