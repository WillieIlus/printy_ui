import { v as useNuxtApp, A as API, w as parseApiError, y as safeLogError } from './server.mjs';
import { ref } from 'vue';
...
const useShopStore = defineStore("shop", () => {
  ...
  function buildShopPayload(data) {
    return {
      name: data.name.trim(),
      slug: slugify(data.name) || `shop-${Date.now()}`
    };
  }
...
//# sourceMappingURL=shop-C66L1Ma3.mjs.map
