...
import { k as useNuxtApp, A as API, I as parseApiError, s as safeLogError, H as extractApiFeedback } from './server.mjs';
import { ref } from 'vue';
...
const useShopStore = defineStore("shop", () => {
  ...
  const selectedShopSlug = useStorage("active-shop-slug", null, localStorage);
...
//# sourceMappingURL=shop-COPLd96Y.mjs.map
