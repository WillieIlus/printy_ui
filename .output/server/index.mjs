...
import { C as toNodeListener, g as destr, G as useRuntimeConfig, D as trapUnhandledNodeErrors, B as setupGracefulShutdown, E as useNitroApp } from './chunks/_/nitro.mjs';
import 'node:events';
import 'node:buffer';
import 'node:fs';
import 'node:path';
