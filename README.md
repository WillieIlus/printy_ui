...
Nuxt 4 frontend for the Printy pricing engine and gallery. Built with Nuxt 4 conventions, type safety, and scalability.
...
Edit `.env` and set `NUXT_PUBLIC_API_BASE` to the full API base, with no trailing slash:
...
# Production
# NUXT_PUBLIC_API_BASE=https://api.printy.ke/api
