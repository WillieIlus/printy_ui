...
export interface HeroFinishingService {
  ...
  rate: number
  products: string[]
  /** Services in the same family are mutually exclusive in the demo UI. */
  family?: 'lamination' | 'binding'
}

export const HERO_FINISHING_SERVICES: HeroFinishingService[] = [
  {
    id: 'lamination_front_gloss',
    label: 'Gloss lamination (front only)',
    pricing_mode: 'per_sheet',
    rate: 12,
    products: ['business_cards', 'flyers', 'brochures', 'stickers'],
    family: 'lamination',
  },
  {
    id: 'lamination_front_matte',
    label: 'Matte lamination (front only)',
    pricing_mode: 'per_sheet',
    rate: 14,
    products: ['business_cards', 'flyers', 'brochures', 'stickers'],
    family: 'lamination',
  ...
  {
    id: 'lamination_both_gloss',
    label: 'Gloss lamination (both sides)',
    pricing_mode: 'per_sheet',
    rate: 25,
    products: ['business_cards', 'flyers', 'brochures', 'stickers'],
    family: 'lamination',
  ...
  },
  {
    ...
    pricing_mode: 'per_piece',
    rate: 0.3,
    products: ['brochures', 'business_cards'],
  },
  {
    id: 'stapling',
    label: 'Stapling',
    pricing_mode: 'flat',
    rate: 80,
    products: ['flyers', 'brochures', 'receipt_books'],
    family: 'binding',
  },
  {
    id: 'booklet_binding',
    label: 'Booklet binding',
    pricing_mode: 'flat',
    rate: 120,
    products: ['brochures'],
    family: 'binding',
  ...
  },
  {
    ...
    pricing_mode: 'flat',
    rate: 300,
    products: ['business_cards', 'flyers', 'brochures'],
  },
  {
    id: 'foil',
    label: 'Foil stamping',
