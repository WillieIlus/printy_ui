...
export const compactSelectUi = {
  ...dashboardSelectUi,
  base: 'relative w-full rounded-lg border border-[var(--p-border)] bg-[var(--p-surface)] ps-3 pe-10 text-[0.95rem] text-[var(--p-text)] transition-all hover:border-[var(--p-text-muted)] focus-within:border-flamingo-500 focus-within:ring-2 focus-within:ring-flamingo-500/20',
...
export const dashboardSurfaceClass = 'rounded-2xl border border-[var(--p-border)] bg-[var(--p-surface-raised)] shadow-sm backdrop-blur-xl'

export const dashboardMutedPanelClass = 'rounded-xl border border-[var(--p-border)] bg-[var(--p-surface-sunken)]'
