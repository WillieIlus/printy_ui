import { hasInjectionContext, getCurrentInstance, shallowReactive, reactive, effectScope, getCurrentScope, inject, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineComponent, createElementBlock, provide, cloneVNode, h, computed, toValue, onServerPrefetch, ref, nextTick, unref, customRef, resolveComponent, shallowReadonly, defineAsyncComponent, Suspense, mergeProps, Fragment, useSSRContext, withCtx, createVNode, renderSlot, createTextVNode, toDisplayString, openBlock, createBlock, createCommentVNode, onErrorCaptured, resolveDynamicComponent, createApp } from "vue";
import { $fetch as $fetch$1, FetchError } from "C:/Users/Admin/Projects/printy/printy_ui/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "C:/Users/Admin/Projects/printy/printy_ui/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "C:/Users/Admin/Projects/printy/printy_ui/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1, getRequestHeader, setCookie, getCookie, deleteCookie } from "C:/Users/Admin/Projects/printy/printy_ui/node_modules/@nuxt/nitro-server/dist/runtime/h3-compat.mjs";
import { hasProtocol, joinURL, withQuery, parseURL, encodePath, decodePath, isScriptProtocol, parseQuery, withTrailingSlash, withoutTrailingSlash } from "C:/Users/Admin/Projects/printy/printy_ui/node_modules/ufo/dist/index.mjs";
import { shouldHydrate, setActivePinia, createPinia, defineStore } from "pinia";
import { defu } from "C:/Users/Admin/Projects/printy/printy_ui/node_modules/defu/dist/defu.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, useRoute as useRoute$1, RouterView } from "vue-router";
import { debounce } from "C:/Users/Admin/Projects/printy/printy_ui/node_modules/perfect-debounce/dist/index.mjs";
import { hash, isEqual } from "C:/Users/Admin/Projects/printy/printy_ui/node_modules/ohash/dist/index.mjs";
import { isPlainObject } from "@vue/shared";
import { klona } from "C:/Users/Admin/Projects/printy/printy_ui/node_modules/klona/dist/index.mjs";
import { parse } from "C:/Users/Admin/Projects/printy/printy_ui/node_modules/cookie-es/dist/index.mjs";
import { useHead as useHead$1, useSeoMeta as useSeoMeta$1, headSymbol } from "C:/Users/Admin/Projects/printy/printy_ui/node_modules/@unhead/vue/dist/index.mjs";
import { ssrRenderComponent, ssrRenderAttrs, ssrRenderSlot, ssrRenderClass, ssrInterpolate, ssrRenderSuspense, ssrRenderVNode } from "vue/server-renderer";
if (!globalThis.$fetch) {
...
const _routes = [
  ...
  },
  {
    ...
    path: "/shop/jobs/:id()",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/_id_-CmpYhT4D.js")
  },
  {
    name: "auth-confirm-email",
    path: "/auth/confirm-email",
    meta: __nuxt_page_meta$i || {},
    component: () => import("./_nuxt/confirm-email-pvPL-9qy.js")
  },
  {
    name: "auth-forgot-password",
    path: "/auth/forgot-password",
    meta: __nuxt_page_meta$h || {},
    component: () => import("./_nuxt/forgot-password-CtruSw0w.js")
  },
  {
    name: "auth-login",
    path: "/auth/login",
    meta: __nuxt_page_meta$g || {},
    component: () => import("./_nuxt/login-Tz7Y4FuK.js")
  },
  {
    name: "auth-register",
    path: "/auth/register",
    meta: __nuxt_page_meta$f || {},
    component: () => import("./_nuxt/register-CC1Tt3eE.js")
  },
  {
    name: "auth-reset-password",
    path: "/auth/reset-password",
    meta: __nuxt_page_meta$e || {},
    component: () => import("./_nuxt/reset-password-j0Upqid-.js")
  },
  {
    name: "dashboard-admin",
    path: "/dashboard/admin",
    meta: { ...__nuxt_page_meta$d || {}, ...{ "middleware": "auth" } },
    component: () => import("./_nuxt/admin-C4oae1LZ.js")
  },
  {
    name: __nuxt_page_meta$9?.name,
    path: "/dashboard/client",
    component: () => import("./_nuxt/client-CxYxet2t.js"),
    children: [
      {
        name: "dashboard-client-section",
        path: ":section()",
        meta: { ...__nuxt_page_meta$b || {}, ...{ "middleware": "auth" } },
        component: () => import("./_nuxt/_section_-59xOI2NT.js"),
        children: [
          {
            name: "dashboard-client-section-id",
            path: ":id()",
            meta: { ...__nuxt_page_meta$c || {}, ...{ "middleware": "auth" } },
            component: () => import("./_nuxt/_id_-BbCLPUZE.js")
          }
        ]
      },
      {
        ...
        component: () => import("./_nuxt/index-CcPtvfd4.js")
      }
    ]
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () => import("./_nuxt/index-D34WzOEf.js")
      }
    ]
  },
  {
    ...
    component: () => import("./_nuxt/index-BBsKZc0Y.js")
  },
  {
    name: "quotes-id",
    path: "/quotes/:id()",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/_id_-C1jAhMXT.js")
  },
  {
    name: "dashboard",
    path: "/dashboard",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/index-Dq8zukfS.js")
  },
  {
    name: "for-shops",
    path: "/for-shops",
    component: () => import("./_nuxt/for-shops-CmqgXQ2F.js")
  },
  {
    name: "track-job",
    path: "/track-job",
    meta: __nuxt_page_meta || {},
    component: () => import("./_nuxt/track-job-BN_kmMn7.js"),
    children: [
      {
        name: "track-job-token",
        path: ":token()",
        meta: __nuxt_page_meta$1 || {},
        component: () => import("./_nuxt/_token_-C6IeVpBC.js")
      }
    ]
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-Be2Kwpwv.js")
  }
];
...
const namedMiddleware = {
  auth: () => import("./_nuxt/auth-vgEK-3X3.js"),
  guest: () => import("./_nuxt/guest-bzf1ZQlT.js")
};
...
const layouts = {
  auth: defineAsyncComponent(() => import("./_nuxt/auth-C7nWTAwc.js").then((m) => m.default || m)),
  dashboard: defineAsyncComponent(() => import("./_nuxt/dashboard-CIJEwOtp.js").then((m) => m.default || m)),
  default: defineAsyncComponent(() => import("./_nuxt/default-DTO1Ajcg.js").then((m) => m.default || m)),
  track: defineAsyncComponent(() => import("./_nuxt/track-CgjvPf35.js").then((m) => m.default || m))
};
...
export {
  ...
  getApiErrorDetail as i,
  getApiErrorMessage as j,
  normalizeApiList as k,
  useAsyncData as l,
  useAuthStore as m,
  navigateTo as n,
  useCookie as o,
